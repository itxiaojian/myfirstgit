package com.zssi.framework.app.test.service;
...
import com.zssi.framework.app.util.WordUtils;
...
public class WordDemo {
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        wordUtils.openDocument(request.getSession().getServletContext().getRealPath("resources/doc/")+"/text.doc");

        //第一级标题样式
        RtfParagraphStyle rtfGsBt1 = RtfParagraphStyle.STYLE_HEADING_1;    
        rtfGsBt1.setAlignment(Element.ALIGN_LEFT);     //左对齐
        rtfGsBt1.setStyle(Font.BOLD);    //加粗
        rtfGsBt1.setSize(15);       //字体大小
