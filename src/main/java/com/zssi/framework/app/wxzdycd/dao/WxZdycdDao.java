package com.zssi.framework.app.wxzdycd.dao;
 ...
 */
@Repository
public class WxZdycdDao extends HibernateBaseDaoImpl<WxZdycd, Integer>{
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getSonMenuList(Integer id) {
