package com.zssi.framework.app.wxzdycd.service;
...
import com.zssi.framework.app.model.WxZdycd;
import com.zssi.framework.app.support.weixin.WeixinUtils;
import com.zssi.framework.app.util.ResponseData;
import com.zssi.framework.app.wxzdycd.dao.WxZdycdDao;
...
//		wxZdycd.setCjsj(new Date());
		wxZdycd.setZt(1);
		zdycdDao.save(wxZdycd);
		return "1";
	}
	 ...
	 */
	@Transactional
	public List<Map<String, Object>> getSonMenu(Integer id) {
