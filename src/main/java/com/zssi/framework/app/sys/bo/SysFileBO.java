...
import com.zssi.framework.app.sys.controller.FileForm;
import com.zssi.framework.app.sys.model.SysFile;
import com.zssi.framework.app.util.AppUtil;
import com.zssi.framework.app.util.GenerateSequenceUtil;
import com.zssi.framework.app.util.OsCheck;
import com.zssi.framework.app.util.SSHHelper;
import com.zssi.framework.app.util.VideoInfo;
import com.zssi.framework.app.util.VideoThumbTaker;
		...
		for (int i = 0; i < fileForm.getFileData().size(); i++) {
			...
			try {
				if (fileData.getSize() > 0) {
					...
					sysFile.setUserId(AppUtil.getCurrentUser().getYhbh().toString());
