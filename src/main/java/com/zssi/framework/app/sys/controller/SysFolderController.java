...
import com.zssi.framework.app.sys.bo.SysFolderBO;
import com.zssi.framework.app.sys.model.SysFolder;
...
public class SysFolderController extends BaseController {
	...
	public String save(ModelMap model,
		...
		entity.setUserId(AppUtil.getCurrentUser().getYhbh().toString());
