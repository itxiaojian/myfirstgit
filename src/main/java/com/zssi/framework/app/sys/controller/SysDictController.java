...
import com.zssi.framework.app.sys.bo.SysSjzdBO;
import com.zssi.framework.app.sys.model.SysSjzd;
import com.zssi.framework.app.util.DictionaryMap;
...
public class SysDictController extends BaseController {
	...
	public String delete(String[] ids) {
		for (String id : ids) {
			sysSjzdBO.remove(Integer.parseInt(id));
		}
		dictionaryMap.clear();
		return "/common/success";
	}
