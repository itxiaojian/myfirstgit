...
//	@GeneratedValue(generator = "idGenerator")
	@GenericGenerator(name = "idGenerator", strategy = "sequence",parameters = {@Parameter(name = "sequence",value="SEQ_SYS_WXYH_ID")})
	@GeneratedValue(generator = "idGenerator")
	...
	@Column(name = "yhgzsj", length = 20, nullable = true)
	public String getYhgzsj() {
		return yhgzsj;
	}

	public void setYhgzsj(String yhgzsj) {
		this.yhgzsj = yhgzsj;
	}
