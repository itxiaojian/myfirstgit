 ...
 * @version 创建时间：2015年10月20日 上午10:20:56 
 * 类说明 
 */
@Entity
@Table(name="Y_RW_WDRW")
@SuppressWarnings("serial")
public class YcbWddb implements Serializable {
	...
	@Id
	@GenericGenerator(name = "idGenerator", strategy = "sequence",parameters = {@Parameter(name = "sequence",value="SEQ_RW_ID")})
