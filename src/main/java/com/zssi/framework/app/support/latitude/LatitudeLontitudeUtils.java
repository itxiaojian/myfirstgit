package com.zssi.framework.app.support.latitude;

public class LatitudeLontitudeUtils {
    ...
    private LatitudeLontitudeUtils(double distance) {  
    ...
    public static Location[] getRectangle4Point(double lat, double lng,  
            double distance) {  
        LatitudeLontitudeUtils llu = new LatitudeLontitudeUtils(distance);  
    ...
    public static void main(String[] args) {  
        ...
        Location[] locations = LatitudeLontitudeUtils.getRectangle4Point(lat,  
                lng, distance);  
        ...
        double d = LatitudeLontitudeUtils.getDistance(lat, lng, lat1, lng1);  
