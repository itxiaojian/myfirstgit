...
package com.zssi.framework.app.common.dao.utils;

import com.zssi.framework.app.common.dao.key.SequenceFactory;
import com.zssi.framework.app.common.dao.key.SingleSequence;
...
public class PrimaryKeyUtil {
	...
	public static Integer getPrimaryKeyInt(String name) {
		SingleSequence sequence = SequenceFactory.getSequence(name);
	    Long num = sequence.getNextVal(name);
		return num.intValue();
	}
