...
import com.zssi.framework.app.common.dao.key.CacheValue;
import com.zssi.framework.app.common.dao.key.UniqueException;
import com.zssi.framework.app.common.dao.key.UniqueTableApp;
...
public class DefaultUniqueTableApp implements UniqueTableApp {
	...
	public DefaultUniqueTableApp(DataSource dataSource) {
		...
		this.selectSQL = "SELECT code FROM UNTECK_PRIMARYKEY WHERE name = ? FOR UPDATE";
