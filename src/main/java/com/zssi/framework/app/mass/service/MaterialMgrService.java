...
import com.zssi.framework.app.mass.dao.MaterialMgrDao;
import com.zssi.framework.app.model.Attachment;
import com.zssi.framework.app.model.WxSucaiInfo;
...
public class MaterialMgrService {
			...
			//FileInputStream fileInputStream = new FileInputStream(attachMentFile.toString());
	            ...
	            if(!result.isEmpty()){
	            	...
	            	if(result.startsWith("error|")){
	            		...
	            		sucai.setCreateUser(user.getYhbh().toString());
	            		...
	            		attachment.setCreateUser(user.getYhbh().toString());
	...
	public Long insertEntity(WxSucaiInfo entity){
		...
		try {
			...
			entity.setCreateUser(user.getYhbh().toString());
			entity.setScType(4);			
