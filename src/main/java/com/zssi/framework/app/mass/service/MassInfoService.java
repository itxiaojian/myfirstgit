package com.zssi.framework.app.mass.service;
...
import com.zssi.framework.app.mass.dao.MassInfoDao;
import com.zssi.framework.app.mass.dao.WxSendallLogDao;
import com.zssi.framework.app.model.WxSendallLog;
import com.zssi.framework.app.support.weixin.WeixinUtils;
import com.zssi.framework.app.util.ResponseData;
import com.zssi.framework.app.util.SecurityContextUtil;
...
public class MassInfoService {
	...
	private void saveSendAllLog(Long toObject, String content, String msgtype, JSONObject jsonObject) {
		...
		sendallLog.setSendUser(SecurityContextUtil.getCurrentUser().getYhbh().toString());
	...
	public ResponseData massPreviewrwfp(String msgtype, String touser,
			String content) {
