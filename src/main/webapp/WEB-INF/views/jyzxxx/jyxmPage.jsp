...
<!--     <link rel="stylesheet" href="css/owl.carousel.css" type="text/css"> -->
  ...
  <div style="display:none;">
          ...
          <section class="wrapper1" style="padding: 0px;">
            ...
            <div class="panel-body" style="padding-left: 0px; padding-right: 0px; padding-bottom: 0px;">
	              ...
	              <div class="form-group" style="height: 35px; margin-bottom: 0px;">
	                  <label class="col-sm-2 control-label" style="width:6%;top: 6px;">检&nbsp;验&nbsp;项&nbsp;目:</label>
					  <div class="col-sm-10" style="width:16%">
					  <input class="form-control" id="jyxm" name="jyxm" value="" style="height:28px;width: 100%;margin-left: 10%" value="${jyxm }"/>
					  </div>
    ...
    <script type="text/javascript" src="<%=path%>/resources/js/jyzxxx/jyxmPage.js"></script>
