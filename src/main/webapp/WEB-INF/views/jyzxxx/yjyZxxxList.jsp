...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jyzxxx/jyZxxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="检验咨询信息">
	<a href="<%=path%>/jyzxxx/YJyZxxx/ZxxxPage" target="content" onfocus="this.blur()"><span>检验咨询信息</span></a>
	</li>
</ul>
</div>
