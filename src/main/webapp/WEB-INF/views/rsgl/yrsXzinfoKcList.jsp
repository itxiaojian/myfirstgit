...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rsgl/rsXzinfoKc.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="薪资扣除">
	<a href="<%=path%>/rsgl/YRsXzinfoKc/XzinfoKcPage" target="content" onfocus="this.blur()"><span>薪资扣除</span></a>
	</li>
</ul>
</div>
