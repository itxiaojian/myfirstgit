...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rsgl/rsJcInfo.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="奖惩管理">
	<a href="<%=path%>/rsgl/YRsJcInfo/JcInfoPage" target="content" onfocus="this.blur()"><span>奖惩管理</span></a>
	</li>
</ul>
</div>
