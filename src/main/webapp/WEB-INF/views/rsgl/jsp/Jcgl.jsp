...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/rsgl/YRsJcInfo/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
<body>
	<div class="wrapper">
		<div class="panel">
			<header class="panel-heading"> 奖惩信息 </header>
			...
			<div class="panel-body">
				...
				<div class="col-sm-13">
					<input class="form-control" type="text" value="${jcInfo.ryxm }" name="ryxm" style="width:100%;height:28px;" required data-msg-required="人员姓名不可空" minlength="1" data-msg-minlength="人员姓名不可空">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-13">
					<input class="form-control Wdate" type="text" value="${jcInfo.khyf }" style="width:100%;height:28px;" name="khyf" onClick="WdatePicker({dateFmt:'yyyy-MM'})" required data-msg-required="生日不可空" minlength="1" data-msg-minlength="生日不可空">
				</div>
			</div>
			<div class="panel-body">
