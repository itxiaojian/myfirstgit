...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/rsgl/YRsPxjlInfo/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
function openwin() {  
   ...
   // location.href="Yh?yhbh="+yhbh;
    window.open("<%=path%>/rsgl/YRsPxjlInfo/Yh?yhbh=="+yhbh, "用户信息", "height=750, width=800, toolbar =no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no") ;
	...
	<div class="wrapper">
		<div class="panel">
			<form action="" class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
		      <input type="hidden" id="id" name="id" value="${pxjl.id }">
			<div class="panel-body">
					<label class="col-sm-2 col-sm-2 control-label"></label>
					<div class="col-sm-10">
						<input class="form-control" type="hidden" value="${pxjl.rybh }"  name="rybh" >
					</div>
				<label class="col-sm-2 col-sm-2 control-label"></label>
				<div class="col-sm-10">
					<input class="form-control" type="hidden" value="${pxjl.ryzh }" name="ryzh">
			</div>
			</div>
			...
			<div class="panel-body">
					...
					<a class="btn btn-xs btn-success" onclick="openwin();" type="submit" style="margin-top:-3px;"> 人员姓名 ：</a>
					</label>
					<div class="col-sm-10">
						<input class="form-control" type="hidden"name="yhbh" id="yhbh"
						>
						<input class="form-control" name="ryxm" id="ryxm" onclick="openwin();" value="${pxjl.ryxm }" style="width:100%;height:28px;">

					</div>
			 
				 <label class="col-sm-2 col-sm-2 control-label">性别：</label>
				<div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="xb" style="width:100%;height:28px;">
							<option selected="selected">${pxjl.xb }</option>
							<c:forEach var="xb" items="${xb}" varStatus="obj">
								<option>${xb.zdmc }</option>
							</c:forEach>
						</select>
				...
				<div class="col-sm-10">
					<input class="form-control Wdate" type="text" value="${pxjl.sr }" name="sr" onClick="WdatePicker({dateFmt:'yyyy-MM-dd '})" style="width:100%;height:28px;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control Wdate" type="text" value="${pxjl.pxsj }" name="pxsj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd '})" style="width:100%;height:28px;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">所属科室：</label>
						<div class="col-sm-10">
							<input id="ks_id" name="ks_id" class="easyui-combotree" value="${pxjl.ks_id } " style="padding-bottom: 2px; width: 221%;">
						</div>
						
				<label class="col-sm-2 col-sm-2 control-label">获得证书名称：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${pxjl.hdzsmc }" name="hdzsmc" style="width:100%;height:28px;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${pxjl.lxdh }" name="lxdh" style="width:100%;height:28px;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">手机号码：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${pxjl.sjhm }" name="sjhm" style="width:100%;height:28px;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">家庭住址：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${pxjl.jtzz }" name="jtzz" style="width:100%;height:28px;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${pxjl.pxmc }" name="pxmc" style="width:100%;height:28px;">
				</div>
			</div>
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">培训内容：</label>
				<div class="col-sm-13">
					<textarea rows="3" class="form-control" name="bz" style="width:100%;">${pxjl.pxnr }</textarea>
				</div>
			</div>
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">备注：</label>
				<div class="col-sm-13">
					<textarea rows="3" class="form-control" name="bz" style="width:100%;">${pxjl.bz }</textarea>
				</div>
			</div>

			<div style="text-align: center">
				<div class="panel-body"  style="width: 100%; border-top-width: 48px;">
