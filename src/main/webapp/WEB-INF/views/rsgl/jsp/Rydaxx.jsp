...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/rsgl/YRsRydaxx/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
	...
	<div class="wrapper">
		<div class="panel">
		 ...
		 <div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="rybh" style="width:100%;" required data-msg-required="人员编号不可空" minlength="1" data-msg-minlength="人员编号不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">人员账号：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" style="width:100%;" name="ryzh">
				</div>
			</div>
				...
				<div div class="panel-body">
						...
						<div class="col-sm-10"  >
							<select class="col-sm-10" name="xb"
								style="width: 100%; height: 25px;">
								<c:forEach var="xb" items="${xb}" varStatus="obj">
									<option value="${xb.zdz }">${xb.zdmc}</option>
								</c:forEach>
							</select>
						</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="ryxm"  style="width:100%;" required data-msg-required="人员姓名不可空" minlength="1" data-msg-minlength="人员姓名不可空">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">生日：</label>
				<div class="col-sm-10">
					<input class="form-control Wdate" type="text" value="" name="sr"  style="width:100%;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" required data-msg-required="生日不可空" minlength="1" data-msg-minlength="生日不可空">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input id="ks_id" name="ks_id" class="easyui-combotree" value=" " style="width:140%;height: 34px;"/>
				</div>
				<label class="col-sm-2 col-sm-2 control-label">联系电话：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="lxdh" style="width:100%;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="sjhm" style="width:100%;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">家庭住址：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="jtzz" style="width:100%;">
				</div>
			</div>
			
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">职务编号：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="zwid" style="width:100%;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">档案附件：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="dafj" style="width:100%;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<!-- <input class="form-control" type="text" value="" name="bz" style="width:720px; hight:200px;"/> -->
					<textarea  class="form-control" rows="3" name="bz" style="width:280%;" ></textarea>
				</div>
			</div> 
