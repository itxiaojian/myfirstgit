...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/rsgl/YRsPxjlInfo/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
	...
	<div class="wrapper">
		<div class="panel">
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="hidden"   name="rybh" 
						<c:if test="${rybh!=null}">
						     value="${rybh}"
						</c:if>
						>
				...
				<label class="col-sm-2 col-sm-2 control-label"></label>
				<div class="col-sm-10">
					<input class="form-control" type="hidden"  name="ryzh" 
					    <c:if test="${ ryzh!=null}">
						     value="${ryzh}"
						</c:if>>
			</div>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						...
						>
						<input class="form-control" name="ryxm" id="ryxm" onclick="openwin();"  style="width:100%;height:28px;">
				...
				<div class="col-sm-10">
					<input class="form-control Wdate" type="text" value="" name="sr" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:100%;height:28px;">
				</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control Wdate" type="text" value="" name="pxsj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:100%;height:28px;">
				</div>
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="hdzsmc" style="width:100%;height:28px;" style="width:100%;height:28px;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="lxdh" style="width:100%;height:28px;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">手机号码：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="sjhm" style="width:100%;height:28px;">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">家庭住址：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="jtzz" style="width:100%;height:28px;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="pxmc"  style="width:100%;height:28px;">
				</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-13">
					<textarea rows="3" class="form-control" name="pxnr" style="width:100%;"></textarea>
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-13">
					<textarea rows="3" class="form-control" name="bz" style="width:100%;"></textarea>
				</div>
			</div>
