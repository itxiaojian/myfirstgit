...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rsgl/rsPxjlInfo.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="培训记录">
	<a href="<%=path%>/rsgl/YRsPxjlInfo/PxjlInfoPage" target="content" onfocus="this.blur()"><span>培训记录</span></a>
	</li>
</ul>
</div>
