...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rsgl/rsRydaxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="人员档案信息">
	<a href="<%=path%>/rsgl/YRsRydaxx/RydaxxPage" target="content" onfocus="this.blur()"><span>人员档案信息</span></a>
	</li>
</ul>
</div>
