...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rsgl/rsXzInfo.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="薪资管理">
	<a href="<%=path%>/rsgl/YRsXzInfo/XzInfoPage" target="content" onfocus="this.blur()"><span>薪资管理</span></a>
	</li>
</ul>
</div>
