	...
	<script type="text/javascript">
		...
		var width = $(window).width();
		    var tabs = new Ext.TabPanel({
		        ...
		        items:[ {
		                title: '图片', 
		                 html:'<iframe src="<%=path%>/wxauth/materialmgr/imageMaterialView" width="100%" height="100%" style="border:0;"></iframe>',
		                 id : 'tp_tab'
		            },
		             {
		                title: '语音', 
		                html:'<iframe src="<%=path%>/wxauth/materialmgr/voiceMaterialView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'yy_tab'
		            } ,
		            {
		                title: '视频', 
		                html:'<iframe src="<%=path%>/wxauth/materialmgr/videoMaterialView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'sp_tab'
		            } ,
		            {
		                title: '图文消息',   
		                html:'<iframe src="<%=path%>/wxauth/materialmgr/tuwenView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'tw_tab'
		            } 
		        ]
		    });
  ...
  <body>
		...
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="素材管理"><a
				href="<%=path%>/wxauth/materialmgr/materialmgrView" target="content"
				onfocus="this.blur()"><span>素材管理</span></a></li>
		</ul>
	</div>
