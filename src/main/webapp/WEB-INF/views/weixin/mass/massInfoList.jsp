<!--  
*****************************************************************
 *description   : 微信群发功能,可以群发普通文本消息、图片、语音、视频、图文消息
******************************************************************
-->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path%>/resources/js/ux/lovCombo/Ext.ux.form.LovCombo.css" />
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ux/ST.ux.util.js"></script>
  	<script type="text/javascript" src="<%=path%>/resources/js/ux/lovCombo/Ext.ux.util.js"></script>
	<script type="text/javascript" src="<%=path%>/resources/js/ux/uxForm.js"></script>
	<script type="text/javascript" src="<%=path%>/resources/js/ux/MultiSelect.js"></script>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ux/uxVtypes.js"></script>
 	<script type="text/javascript" src="<%=path%>/resources/js/ux/lovCombo/Ext.ux.form.LovCombo.js"></script>
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/staticData.js"></script>
 	<script type="text/javascript" src="<%=path%>/resources/js/weixin/mass/massInfo.js"></script>
...
<body style="background-color: #ffffff;">
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="微信群发管理"><a
				href="<%=path%>/wxauth/mass/massInfoPage" target="content"
				onfocus="this.blur()"><span>群发管理</span></a></li>
		</ul>
	</div>
