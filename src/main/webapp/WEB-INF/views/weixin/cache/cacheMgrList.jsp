<!--  
*****************************************************************
 *description   : 微信缓存管理(管理cache.names = weixin的缓存)
******************************************************************
-->
...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/staticData.js"></script>
 	<script type="text/javascript" src="<%=path%>/resources/js/weixin/cache/cacheMgr.js"></script>
...
<body style="background-color: #ffffff;">
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="微信用户管理"><a
				href="<%=path%>/wxauth/user/wxUser" target="content"
				onfocus="this.blur()"><span>微信用户管理</span></a></li>
		</ul>
	</div>
