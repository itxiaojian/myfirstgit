...
function save() {
	msg="确定要提交？";
	if (confirm(msg)) {
		var url = "<%=path%>/khgl/YKhHyxx/save";
		$.ajax({
			cache : true,
			type : "POST",
			url : url,
		...
		<header class="panel-heading"></header>
		 <form class="form-horizontal tasi-form" name="myForm" id="myForm" method="post" enctype="multipart/form-data">
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="hymc"  required data-msg-required="行业名称必填" minlength="1" data-msg-minlength="行业名称必填">
				</div>
			</div>
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				<label class="col-sm-2 col-sm-2 control-label">所属分类：</label>
						<div class="col-sm-10">
							<select class="form-control input-lg m-bot15" name="ssfl" style="padding-left: 2px;">
							    <option selected="selected" value="1">一级分类</option>
								<c:forEach var="ssfl" items="${ssfl}" varStatus="obj">
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>分类级别：</label>
						<div class="col-sm-10">
							<select class="form-control input-lg m-bot15" name="jb" style="padding-left: 2px;"  required data-msg-required="分类级别必填" minlength="1">
							    <option selected="selected" value="">请选择...</option>
								<c:forEach var="jb" items="${jb}" varStatus="obj">
			...
			<div class="form-group"style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<textarea class="form-control" truetype="textarea"  name="bz" rows="3" style="height:100px;">${hyxx.bz }</textarea>
				</div>
			</div>
			<div style="padding-left: 237px;">
				<div class="form-group" style="margin-left: -47px; margin-top: 16px;">
