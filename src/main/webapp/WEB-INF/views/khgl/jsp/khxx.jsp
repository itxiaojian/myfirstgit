 ...
 $(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg1="该证件号码已存在是否重复录入？";
          if (confirm(msg)) {
              var url = "<%=path%>/khgl/YKhKhxx/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
                  ...
                  success : function(data) {
						...
						if (data == '1') {
				            ...
				            window.parent.ACT_DEAL_WINDOW.close();
					              ...
					              var url = "<%=path%>/khgl/YKhKhxx/save1";
					              $.ajax({
					                  cache: true,
					                  type: "POST",
					                  url: url,
...
<body>
		...
		<header class="panel-heading" style="padding-top: 0px; padding-bottom: 0px;"><b style="font-size: 13px;margin-left: 38%;">主体信息（客户编号：<%=year%>${khbh}<span style="color:red">*</span>）</b></header>
			<form action="" class="form-horizontal tasi-form bl-form bl-formhor" name="myForm" id="myForm" method="post">
			<input type="hidden" name="khbh" id="khbh" value="<%=year%>${khbh}">
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="khmc" name="khmc" required data-msg-required="单位名称必填" minlength="1"  style="width:110%;">
				</div>
				 <label class="col-sm-2 col-sm-2 control-label">客户生日：</label>
                  <div class="col-sm-10">
                  <input class="form-control Wdate" style="width:110%;" type="text" id="sr" name="sr" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
                  </div>
				<label class="col-sm-2 col-sm-2 control-label">省市县区：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" style="width:110%;" id="ds" name="ds">
				</div>
			</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				  ...
				  <div class="col-sm-10">
					<input class="form-control" type="text" style="width:110%;" id="khdz" name="khdz" required data-msg-required="详细地址必填" minlength="1" >
				  </div>
				  <label class="col-sm-2 col-sm-2 control-label">单位网址：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" style="width:110%;" id="dwwz" name="dwwz">
					</div>
				  <label class="col-sm-2 col-sm-2 control-label">成立时间：</label>
                  <div class="col-sm-10">
                  <input class="form-control Wdate" type="text" id="clsj" name="clsj" style="width:110%;" onClick="WdatePicker({dateFmt:' yyyy-MM-dd'})" >
                  </div>
			</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
			   <label class="col-sm-2 col-sm-2 control-label">单位性质：</label>
					<div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="dwxz" style="font-size:12px; height:25px;width:110%;" >
							 			<option selected="selected" value="">请选择...</option>
								<c:forEach var="dwxz" items="${dwxz}" varStatus="obj">
										<option>${dwxz.zdmc}</option>
								</c:forEach>
						</select>
	                </div>
	            <label class="col-sm-2 col-sm-2 control-label">主导产品：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" id="jycpmc" name="jycpmc" style="width:110%;">
				    </div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="ywje" name="ywje" style="width:110%;"onkeyup="value=value.replace(/[^\d]/g,'') "   
				...
				<div class="col-sm-10">
					<select class="form-control input-lg m-bot15" name="khfl" style="font-size:12px; height:25px;width:110%;"  >
						<option selected="selected" value="">请选择...</option>
						<c:forEach var="khfl" items="${khfl}" varStatus="obj">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" style="width:110%;" id="ydjzh" name="ydjzh" value="<%=year%>${khbh}" readonly="readonly">
				</div>
			</div>
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				<label class="col-sm-2 col-sm-2 control-label" >证件类型：</label>
				<div class="col-sm-10" >
					<select class="form-control input-lg m-bot15" name="zjlx" style="font-size:12px; height:25px;width:110%;" >
						<option selected="selected"value="">请选择...</option>
				<c:forEach var="zjlx" items="${zjlx}" varStatus="obj">
						<option>${zjlx.zdmc}</option>
				</c:forEach>
					</select>
				</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%; ">
				...
				<div class="col-sm-10" >
					<input class="form-control" type="text" id="frxm" name="frxm" style="width:110%;">
			    </div>
			    <label class="col-sm-2 col-sm-2 control-label" >联络人员：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" style="width:110%;" id="lxr" name="lxr" >
				</div>
			</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="sjhm" name="sjhm" style="width:110%;"   placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                                                        data-msg-mobile="请输入正确的格式">
				</div>
				<label class="col-sm-2 col-sm-2 control-label" >手机号码：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="sjhm1" name="sjhm1" style="width:110%;"   placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                                                        data-msg-mobile="请输入正确的格式">
				</div>
			</div>
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
			...
			<label class="col-sm-2 col-sm-2 control-label" >固定电话：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="gddh1" name="gddh1" style="width:110%;" onkeyup="value=value.replace(/[^\d]/g,'') "   
                                   onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
				</div>
		    </div>
		    <div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="cz" name="cz" style="width:110%;" data-rule-fax="true" 
                                                        data-msg-fax="请输入正确的传真格式" data-msg-minlength="请输入正确的传真格式" >
				</div>
				<label class="col-sm-2 col-sm-2 control-label" >传真号码：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="cz1" name="cz1" style="width:110%;" data-rule-fax="true" 
                                                        data-msg-fax="请输入正确的传真格式" data-msg-minlength="请输入正确的传真格式" >
				</div>
		    ...
		    <div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="dzyx" name="dzyx" style="width:110%;" >
				</div>
				<label class="col-sm-2 col-sm-2 control-label" >电子邮箱：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="dzyx1" name="dzyx1" style="width:110%;">
				</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="frqq" name="frqq" style="width:110%;"onkeyup="value=value.replace(/[^\d]/g,'') "   
                          onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
				</div>
				<label class="col-sm-2 col-sm-2 control-label" >联络QQ：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="llqq" name="llqq" style="width:110%;" onkeyup="value=value.replace(/[^\d]/g,'') "   
                          onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
				</div>
