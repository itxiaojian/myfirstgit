...
<div style="display:none;">
	<ul class="tab-menu tab" id="tabMenuID_">
		<li class="tab-selected" title="客户信息查询">
			<a href="<%=path%>/khgl/khxxcx/openPage" target="content" onfocus="this.blur()"><span>客户信息查询</span></a>
		</li>
	</ul>
</div>
				...
				<div style="padding: 15px;">
					<div class="row" style="width:50%;float:left;padding-left: 15px;">
						<form action="" method="post" id="myForm">
							...
							<textarea rows="" cols="" readonly="readonly" id="xsmc" name="xsmc" style="width:100%;height: 130px;resize: none;" class="form-control1 textarea"></textarea>
							<label>字段：</label>
							...
							<div style="width: 100%;margin-top: 10px;" align="center">
								<input class="btn btn-success" type="button" style="width: 60px;" onclick="addTj();" value="增加">
								<input class="btn btn-success" type="button" style="margin-left: 3%; width: 60px;" onclick="getValue();" value="查询">
								<input class="btn btn-success" type="button" style="margin-left: 3%; width: 60px;" onclick="doEmpty();" value="清空">
								<input class="btn btn-success" type="button" style="margin-left: 3%; width: 90px;" onclick="getExcelValue();" value="导出Excel">
							</div>
						</form>
					</div>
					...
					<div class="row" style="width:50%;float:left;margin-left: 3%;">
						<div class="col-xs-5">
							<select name="from" id="multiselect" class="form-control" size="10" multiple="multiple" da style="height: 203px;">
								<c:forEach var="data" items="${zdmc }" varStatus="obj">
									<option value="${data.code }">${data.name }</option>
								</c:forEach>
							</select>
						...
						<div class="col-xs-5">
							<select name="to" id="multiselect_to" class="form-control" size="10" multiple="multiple" style="height: 203px;"></select>
						</div>
					</div>
				</div>
