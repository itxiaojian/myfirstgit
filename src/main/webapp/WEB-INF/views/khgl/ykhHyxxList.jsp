...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/khgl/hyxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="客户分类">
	<a href="<%=path%>/khgl/YKhHyxx/HyxxPage" target="content" onfocus="this.blur()"><span>客户分类</span></a>
	</li>
</ul>
</div>
