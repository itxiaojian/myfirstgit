...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/khgl/hfxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="客户回访记录">
	<a href="<%=path%>/khgl/YKhHfxx/HfxxPage" target="content" onfocus="this.blur()"><span>客户回访记录</span></a>
	</li>
</ul>
</div>
