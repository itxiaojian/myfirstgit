...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/runningProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="运行中的流程">
	<a href="<%=path%>/cps/processXN/runningProcess" target="content" onfocus="this.blur()"><span>运行中的流程</span></a>
	</li>
</ul>
</div>
