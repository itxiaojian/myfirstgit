...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/rwchProcess.js"></script>
<style>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="任务撤回">
	<a href="<%=path%>/cps/processXN/rwchProcess" target="content" onfocus="this.blur()"><span>任务撤回</span></a>
	</li>
</ul>
</div>
