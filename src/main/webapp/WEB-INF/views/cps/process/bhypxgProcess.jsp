...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/weixin_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/bhypxgProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="驳回样品修改">
	<a href="<%=path%>/cps/processXN/bhypxgProcess" target="content" onfocus="this.blur()"><span>驳回样品修改</span></a>
	</li>
</ul>
</div>
