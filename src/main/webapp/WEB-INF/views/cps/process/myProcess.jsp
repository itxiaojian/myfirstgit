...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/myProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="我的流程">
	<a href="<%=path%>/cps/processXN/myProcess" target="content" onfocus="this.blur()"><span>我的流程</span></a>
	</li>
</ul>
</div>
