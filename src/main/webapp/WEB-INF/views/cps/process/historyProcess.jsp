...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/historyProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="历史流程">
	<a href="<%=path%>/cps/processXN/historyProcess" target="content" onfocus="this.blur()"><span>历史流程</span></a>
	</li>
</ul>
</div>
