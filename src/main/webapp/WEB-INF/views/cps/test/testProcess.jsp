...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/test/testProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="流程部署">
	<a href="<%=path%>/cps/processXN/deployProcessPage" target="content" onfocus="this.blur()"><span>启动流程</span></a>
	</li>
</ul>
</div>
