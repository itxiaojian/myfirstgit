	        ...
	        xmlHttp.onreadystatechange = function(){
	            if(xmlHttp.readyState==4){
	                if(xmlHttp.status==200){
	    				...
	    				document.getElementById('test1').src='<%=path%>/jygl/YjyBgxx/pzrtwo?bgbh='+bgbh+'&key='+businessKey;
	                }
	            }
	        }
	    }
...
<!-- 				<textarea name="signData" hidden=true cols="60" rows="6" id="signDataID"></textarea> -->
				<div align="center">
					<br>
<!-- 					<input type="submit" class="btn btn-primary" onclick="agree();" value="通过" /> -->
