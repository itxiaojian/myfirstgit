...
<%--             <iframe id="test1" src="<%=path%>/jygl/YjyBgxx/pzrtoo?bgbh=${bgbh }&key=${businessKey} " --%>
...
<form name="submitForm" id="optionForm" method="post">
	<div class="panel panel-success">
	  <div id="opinionDiv" class="panel-heading">填写检验情况:</div>
	  <div class="panel-body" >
			...
			<input type="hidden" name="projectName" id="projectName" value="${pageContext.request.contextPath}"/>
				...
				<input type="hidden" name = "jyksbh" value="${mapBusi.jyksbh}" />
				...
				<div align="center">
					<br>
					<input type="submit" class="btn btn-primary" onclick="agree();" value="接收" />
				</div>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/cps/deal/dealYWKSJSAct',   //默认是form的action， 如果申明，则会覆盖 
