	...
	<div class="panel panel-success">
		...
		<table class="table table-bordered">
			<tr>
				...
				<td><a onclick="viewCreditPdf();" title="点击查看样品信息">${mapBusi.ypmc}</a></td>
			</tr>
		</table>
	</div>	  
...
<form name="submitForm" id="optionForm" method="post">
	<div class="panel panel-success">
	  <div id="opinionDiv" class="panel-heading">填写修改情况:</div>
	  <div class="panel-body" >
			...
			<input type="hidden" name="projectName" id="projectName" value="${pageContext.request.contextPath}"/>
				...
				<div align="center">
					<br>
					<input type="submit" class="btn btn-primary" onclick="agree();" value="修改提交" />
				</div>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/cps/deal/dealYWQTDJXGAct',   //默认是form的action， 如果申明，则会覆盖 
