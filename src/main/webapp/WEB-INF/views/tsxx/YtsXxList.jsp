...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/tsxx/tsxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="投诉信息">
	<a href="<%=path%>/tsxx/YtsXx/TsxxPage" target="content" onfocus="this.blur()"><span>投诉信息</span></a>
	</li>
</ul>
</div>
