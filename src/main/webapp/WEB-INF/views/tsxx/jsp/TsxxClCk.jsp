		...
		<div class="panel">
			...
			<form action="" class="form-horizontal tasi-form" name="myForm"
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text"   style="width:400%;"
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value="${tsxx.tsr }" disabled="true"  style="width:400%;"
							name="tsr"  >
					</div>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="tslx"    disabled="true"           
							style="font-size: 14px; height: 25px;width:400%;">
                ...
                <div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text"  style="width:400%;"
							value="${tsxx.tsrq }" name="tsrq" disabled="true"
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<textarea class="form-control"  rows="3" disabled="ture" truetype="textarea"  name="tsnr" style="width: 400%;">${tsxx.tsnr}</textarea>
					</div>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="3"  disabled="ture" truetype="textarea"  name="cljg" style="width: 400%;">${tsxx.cljg}</textarea>
					</div>
				</div>
				<div class="panel-body">
					<label class="col-sm-2 col-sm-2 control-label">备注：</label>
					<div class="col-sm-10">
						<textarea class="form-control"  disabled="ture" truetype="textarea"  name="bz" style="width: 400%;">${tsxx.bz}</textarea>
					</div>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="hidden" value="${tsxx.clzt}" disabled="true"
							name="clzt">
					</div>
				</div>
