...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yxxgl/xxmb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="消息管理">
	<a href="<%=path%>/yxxgl/xxmbPage" target="content" onfocus="this.blur()"><span>消息管理</span></a>
	</li>
</ul>
</div>
