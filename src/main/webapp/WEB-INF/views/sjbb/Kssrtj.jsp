...
<html lang="en">
  ...
  <div style="display:none;">
    <ul class="tab-menu tab" id="tabMenuID_">
        <li class="tab-selected" title="科室收入统计">
            <a href="<%=path%>/sjbb/Ygfltj/KssrtjPage" target="content" onfocus="this.blur()"><span>科室收入统计</span></a>
        </li>
    </ul>
  </div>
      <!--main content start-->
	            	...
	            	var del = $("#table");
	             	...
	             	for(var i=0;i<data.length;i++){
	             		if (data[i].PX == 2 || data[i].PX == 4 || data[i].PX == 6 || data[i].PX == 8){
	                 		...
	                 		+"<td style='text-align:center;'><b>"+data[i].HJYSK+"</b></td>"
	                 		+"<td style='text-align:center;'><b>"+data[i].HJYSF+"</b></td>"
