...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ux/ClerkSelectField.js"></script>
<%-- 	<script type="text/javascript" src="<%=path%>/resources/js/khgl/khxx.js"></script> --%>
	<script type="text/javascript" src="<%=path%>/resources/js/sgzgl/sgzgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="上岗证信息">
	<a href="<%=path%>/sgzgl/YsgzXx/SgzxxPage" target="content" onfocus="this.blur()"><span>上岗证信息</span></a>
	</li>
</ul>
</div>
