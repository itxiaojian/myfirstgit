...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/sgzgl/YsgzXx/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
		...
		<div class="panel">
			<form action="" class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value="${sgzxx.sgzbh }"  name="sgzbh" style="width:100%;height:28px;" required data-msg-required="上岗证编号必填" minlength="1" data-msg-minlength="必填">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">人员编号：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${sgzxx.rybh }" name="rybh" style="width:100%;height:28px;" required data-msg-required="上岗证编号必填" minlength="1" data-msg-minlength="必填" >
				</div>
				...
				<div class="col-sm-10">
					...
					<select class="form-control input-lg m-bot15" name="cplx" style="width:100%;height:28px;" >
						<option selected="selected">${sgzxx.cplx }</option>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control Wdate"  type="text" value="${sgzxx.yxq }" name="yxq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:100%;height:28px;" >
				</div>
				
				<label class="col-sm-2 col-sm-2 control-label">职称编号：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${sgzxx.zcid }"  name="zcid" style="width:100%;height:28px;">
				</div>
				
				<label class="col-sm-2 col-sm-2 control-label">所属科室名称：</label>
				<div class="col-sm-10" style="padding-top: 3px;">
					     <input class="easyui-combotree" type="text" id="ks_id" name="ks_id" value="${sgzxx.bmmc }" style="width:221%;">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-13">
					<textarea class="form-control" truetype="textarea"  name="kczsb" rows="3" style="width:99.5%;">${sgzxx.bz }</textarea>
				</div>
			</div>
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">备注：</label>
				<div class="col-sm-13">
					<textarea class="form-control"  truetype="textarea"  name="bz" rows="3" style="width:99.5%; ">${sgzxx.bz }</textarea>
				</div>
			</div>
