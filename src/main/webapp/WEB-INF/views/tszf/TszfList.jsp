...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/tszf/tszf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="特殊字符">
	<a href="<%=path%>/tszf/SysTszf/TszfPage" target="content" onfocus="this.blur()"><span>特殊字符</span></a>
	</li>
</ul>
</div>
	<form method="post" id="searchForm" action="<%=path%>/sys/SysUser/list">
	<input type="hidden" id="startId" name="start" value="0"/>	
	<input type="hidden" id="limitId" name="limit" value="20"/>
