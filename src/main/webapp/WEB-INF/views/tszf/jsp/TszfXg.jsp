...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/tszf/SysTszf/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
<body>
	<div class="wrapper">
		<div class="panel">
			...
			<c:forEach var="tszfxx" items="${tszfxx}" varStatus="obj">
			<input type="hidden" name="id" id="id" value="${tszfxx.id }">
			
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">特殊字符：</label>
				<div class="col-sm-10">
					<input class="form-control" id="tszf" type="text" value="${tszfxx.tszf }" name="tszf" style="width:350%;" required data-msg-required="特殊字符不能为空" minlength="1" data-msg-minlength="特殊字符不能为空">
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
						<textarea class="form-control" id="bz" truetype="textarea"  name="bz" rows="3" style="width:350%; height:150px;">${tszfxx.bz }</textarea>
				</div>
			</div>

			<div style="text-align: center">
				<div class="panel-body" style="margin-top: 45px; margin-left: -90px;">
