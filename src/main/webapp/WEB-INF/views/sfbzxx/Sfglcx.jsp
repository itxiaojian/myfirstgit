...
<div style="display:none;">
	<ul class="tab-menu tab" id="tabMenuID_">
		<li class="tab-selected" title="收费标准查询">
			<a href="<%=path%>/sfgl/sfglcx/openPage" target="content" onfocus="this.blur()"><span>收费标准查询</span></a>
		</li>
	</ul>
</div>
<section id="container" >
	...
	<section id="main-content1">
		<section class="wrapper1">
			<!-- page start-->
			<section class="panel">
				<header class="panel-heading"><a href="<%=path%>/sfgl/sfglcx/openPage" target="content" onfocus="this.blur()"><span>收费标准查询</span></a></header>
...
<script type="text/javascript">
    	...
    	<%
    	// 这段可以用EL和JSTL等方法代替
     	List<Map<String,Object>> jldw=(List)request.getAttribute("jldw");
     	for (Map<String,Object> currentValue : jldw) {%>
    	// 这段服务器端得部分可以用EL和JSTL代替
    	idList.push("<%=currentValue.get("zdz")%>");
    	mcList.push("<%=currentValue.get("zdmc")%>");
    	<% } %>
    </script>
<script type="text/javascript" src="<%=path%>/resources/js/sfbzxx/sfglcx.js"></script>
