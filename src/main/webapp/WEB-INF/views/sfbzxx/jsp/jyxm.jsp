              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <form action="<%=path%>/bzxx/YsfBzxx/jyxm" id="myForm" style="margin-top: 7px;" method="post">
                          ...
                          <table class="table table-striped table-advance table-hover" style="margin-top: 8px;border-top: 2px solid #ddd;">
                              ...
                              <tr>
                                  ...
                                  <th style="width: 110px;">检验项目编号</th>
                                  <th style="width: 130px;">检验项目名称</th>
                                  <th>操作</th>
                              </tr>
                              </thead>
                              <tbody>
							  ...
							  <tr>
							  	  <td style="display:none;"><input type="hidden" name="id" value="${jyxm.id }"/>${jyxm.id }</td>
                                  <td><input type="hidden" name="bzbh" value="${jyxm.xmbh }"/>${jyxm.xmbh }</td>
                                  <td><input type="hidden" name="bzmc" value="${jyxm.xmmc }"/>${jyxm.xmmc }</td>
                                  <td>
                                 	  <label class="label_check" for="checkbox-02">
	                                 	<a href="javascript:void(0);" class="btn btn-primary" onClick="save('${jyxm.id}','${id }');">提交</a>
									  </label>
                                  </td>
                              </tr>
                              </c:forEach>
...
<script  type="text/javascript">
 ...
 function save(id,viewId){
			location.href="<%=path%>/bzxx/YsfBzxx/sfxmView?ids="+id+"&id="+viewId;
 };
</script> 
