...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sfbzxx/bzxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="标准收费信息">
	<a href="<%=path%>/bzxx/YsfBzxx/BzxxPage" target="content" onfocus="this.blur()"><span>收费标准信息</span></a>
	</li>
</ul>
</div>
