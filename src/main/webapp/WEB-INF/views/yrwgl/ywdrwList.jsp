...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yrwgl/ywdrw.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/yrwgl/ywdrw/ywdrwPage" target="content" onfocus="this.blur()"><span>我的任务</span></a>
	</li>
</ul>
</div>
