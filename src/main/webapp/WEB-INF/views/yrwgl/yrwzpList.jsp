...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yrwgl/yrwzp.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="任务管理">
	<a href="<%=path%>/yrwgl/yrwzp/yrwzpPage" target="content" onfocus="this.blur()"><span>任务指派</span></a>
	</li>
</ul>
</div>
