...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yrwgl/yrwxd.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/yrwgl/yrwxd/yrwxdPage" target="content" onfocus="this.blur()"><span>任务下达</span></a>
	</li>
</ul>
</div>
