...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cbgl/cwCbxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="成本信息">
	<a href="<%=path%>/cbgl/YCwCbxx/CbxxPage" target="content" onfocus="this.blur()"><span>成本信息</span></a>
	</li>
</ul>
</div>
