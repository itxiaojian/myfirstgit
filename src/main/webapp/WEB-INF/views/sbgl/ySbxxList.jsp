...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/ySbxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="设备信息项"> 
	<a href="<%=path%>/sbgl/YSbXx/SbxxPage" target="content" onfocus="this.blur()"><span>设备信息</span></a>
	</li>
</ul>
</div>
