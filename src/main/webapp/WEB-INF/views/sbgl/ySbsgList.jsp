...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/ySbsg.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="设备申购"> 
	<a href="<%=path%>/sbgl/YSbSg/SbsgPage" target="content" onfocus="this.blur()"><span>设备申购</span></a>
	</li>
</ul>
</div>
