...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/ySbsyjl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="设备使用记录"> 
	<a href="<%=path%>/sbgl/YsbSyjl/SbsyjlPage" target="content" onfocus="this.blur()"><span>设备使用记录</span></a>
	</li>
</ul>
</div>
