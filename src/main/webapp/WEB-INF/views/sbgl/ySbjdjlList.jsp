...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/ySbjdjl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="设备检定记录"> 
	<a href="<%=path%>/sbgl/YsbJdjl/SbjdjlPage" target="content" onfocus="this.blur()"><span>设备检定记录</span></a>
	</li>
</ul>
</div>
