			...
			<div style="text-align:center;margin-bottom:-2px"></div>
                ...
                <c:forEach var="sbxx" items="${sbxx}" varStatus="obj">
					...
					<div class="form-group" style="padding-bottom: 2px;margin-bottom: 0px;margin-top: 4px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>维修内容：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="wbnr" name="wbnr">
						</div>
						<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>维修日期：</label>
						<div class="col-sm-10">
							<input class="form-control Wdate" id="wbsj" name="wbsj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
						</div>
						<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>维修人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="wbr" name="wbr">
						</div>
					</div>
					...
					<div class="form-group" style="padding-bottom: 2px;margin-bottom: 0px;padding-top: 0px;width: 101%;">
						...
						<div class="col-sm-10">
							<input class="form-control Wdate"  name="xcjdrq" disabled="true" value="${sbxx.xcjdrq}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
						</div>
