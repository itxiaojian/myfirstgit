			...
			<div style="text-align:center;margin-bottom:-2px"></div>
                ...
                <c:forEach var="sbxx" items="${sbxx}" varStatus="obj">
                    ...
                    <div class="form-group" style="padding-bottom: 2px;margin-bottom: 0px;margin-top: 4px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>停用原因：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="tyyy" name="tyyy"">
						</div>
						<label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>停用日期：</label>
						<div class="col-sm-10">
							<input name="tyrq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="form-control Wdate" />
						</div>
				   </div>
					...
					<div style="text-align: center">
						   <div class="form-group" style="margin-top: 5px;width: 90%; margin-left: 105px;">
...
function save() {
	msg="确定要提交？";
	if (confirm(msg)) {
		var url = "<%=path%>/sbgl/YSbXx/onStop";
		$.ajax({
			cache : true,
			type : "POST",
			url : url,
