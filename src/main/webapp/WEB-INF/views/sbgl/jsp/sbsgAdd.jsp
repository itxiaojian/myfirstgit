			...
			<div style="text-align:center;margin-bottom:-2px"></div>
                <form class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="" name="sgbh"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<select class="form-control input-lg m-bot15" name="sblx"
								name="sblx" style="font-size: 14px; height: 25px;">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="" name="sbxh"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<select class="form-control input-lg m-bot15" name="sbjb"
								style="font-size: 14px; height: 25px;">
								<option selected="selected" value="">请选择...</option>
								<c:forEach var="sbjb" items="${sbjb}" varStatus="obj">
									<option>${sbjb.zdmc }</option>
								</c:forEach>
							</select>
						</div>
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="" name="syfw"
								style="width: 100%; height: 25px;" id="syfw">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">生产厂家：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="" name="sccj"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" value=""
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="" name="sbsgr"
