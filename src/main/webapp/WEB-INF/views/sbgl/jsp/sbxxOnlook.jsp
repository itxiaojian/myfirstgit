...
function exit1(){
	var jdzs=$('#jdzs').val();
	var jdzssub=$('#jdzssub').val();
	location.href="<%=path%>/sbgl/YSbXx/jdzsck?jdzs="+jdzs+"&jdzssub="+jdzssub;
}
...
<%-- 							<input class="form-control" type="text" id="syks" name="syks" disabled="true" value="${sbxx.syks }" > --%>
						</div>
					...
					<div class="form-group" style="padding-bottom: 2px;margin-bottom: 0px;padding-top: 0px;width: 101%;">
						...
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" id="xcjdrq" name="xcjdrq" value="${sbxx.xcjdrq }" disabled="true" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
							onkeyup="value=value.replace(/[^\d]/g,'') "   
                            onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
						</div>
					...
					<div class="form-group" style="padding-bottom: 2px;margin-bottom: 0px;padding-top:0px;width: 101%;">
                        ...
                        <div class="col-sm-10">
                              <input class="form-control" type="text" id="jdzs" name="jdzs" disabled="true" value="${sbxx.jdzs}">
						</div>
						<c:if test="${sbxx.jdzs == null}">
						<div class="col-sm-10" style="width: 6%;margin-top: 5px;">
							<b style="color:red;">未上传</b>
						</div>
						</c:if>
						<c:if test="${sbxx.jdzs != null}">
						<div class="col-sm-10" style="width: 6%;">
							<input type="hidden" id="jdzs" name="jdzs" value="${sbxx.jdzs}">
							<input type="hidden" id="jdzssub" name="jdzssub" value="${sbxx.jdzssub}">
							<a class="btn btn-xs btn-sucess" onClick="exit1();" style="margin-top: 5px;">点击查看</a>
                        </div>
						</c:if>
						<label class="col-sm-2 col-sm-2 control-label" style="width: 7%;">使用部门：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="sybm" name="sybm" disabled="true" value="${sbxx.sybm }">
						</div>
					</div>
					<div class="form-group" style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
