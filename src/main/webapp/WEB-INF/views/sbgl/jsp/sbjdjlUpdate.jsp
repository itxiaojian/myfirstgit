			...
			<div style="text-align:center;margin-bottom:-2px"></div>
                ...
                <c:forEach var="sbjdjl" items="${sbjdjl}" varStatus="obj">
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.sbbh }" name="sbbh"
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.sbmc }" name="sbmc"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.sbtxm }" name="sbtxm"
								style="width: 100%;" id="sbtxm" >
						</div>
						<label class="col-sm-2 col-sm-2 control-label">检验开始时间：</label>
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" value="${sbjdjl.sysj }" name="sysj"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.jybh }" name="jybh"
								style="width: 100%;" id="jybh" >
						</div>
						<label class="col-sm-2 col-sm-2 control-label">检验报告编号：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.bgbh }" name="bgbh"
					...
					<div class="panel-body" >
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" id="jddw" name="jddw" value="${sbjdjl.jddw }">
						</div>
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.jdjg }" name="jdjg"
								style="width: 100%;" id="jdjg" >
						</div>
						<label class="col-sm-2 col-sm-2 control-label">检定结论：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.jdjl }" name="jdjl"
					...
					<div class="panel-body">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.jdfy }" name="jdfy"
								style="width: 100%;" id="jdfy" >
						</div>
						<label class="col-sm-2 col-sm-2 control-label">检定人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${sbjdjl.jdr }" name="jdr"
					 ...
					 <div class="panel-body">
						...
						<div class="col-sm-10">
							<textarea class="form-control" truetype="textarea" id="bz"
								name="bz" rows="3" style="width: 280%; height: 120px;">${sbjdjl.bz }</textarea>
						</div>
					</div>
...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
        	  var url = "<%=path%>/sbgl/YsbJdjl/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
