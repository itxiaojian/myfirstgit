...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/ySbbxjl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="设备维修记录"> 
	<a href="<%=path%>/sbgl/YsbBxjl/SbbxjlPage" target="content" onfocus="this.blur()"><span>设备维修记录</span></a>
	</li>
</ul>
</div>
