...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dbgl/yCbLbxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="督办列表"> 
	<a href="<%=path%>/dbgl/YdbDblb/DblbPage" target="content" onfocus="this.blur()"><span>督办列表</span></a>
	</li>
</ul>
</div>
