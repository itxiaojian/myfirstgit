...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dbgl/yCbWddb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="我的督办"> 
	<a href="<%=path%>/dbgl/YdbWddb/WddbPage" target="content" onfocus="this.blur()"><span>我的督办</span></a>
	</li>
</ul>
</div>
