...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dbgl/yCbYwdb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="业务督办"> 
	<a href="<%=path%>/dbgl/YdbYwdb/YwdbPage" target="content" onfocus="this.blur()"><span>业务督办</span></a>
	</li>
</ul>
</div>
