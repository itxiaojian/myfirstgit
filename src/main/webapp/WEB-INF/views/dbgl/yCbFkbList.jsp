...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dbgl/yCbFkb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="反馈列表"> 
	<a href="<%=path%>/dbgl/YdbFklb/FklbPage" target="content" onfocus="this.blur()"><span>反馈列表</span></a>
	</li>
</ul>
</div>
