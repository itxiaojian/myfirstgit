...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dagl/yDaLmgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="档案类目管理"> 
	<a href="<%=path%>/dagl/YdaLmgl/DaLmglPage" target="content" onfocus="this.blur()"><span>档案类目管理</span></a>
	</li>
</ul>
</div>
