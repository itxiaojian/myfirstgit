...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dagl/yDaBgqx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="保管期限管理"> 
	<a href="<%=path%>/dagl/YdaBgqx/DaBgqxPage" target="content" onfocus="this.blur()"><span>保管期限管理</span></a>
	</li>
</ul>
</div>
