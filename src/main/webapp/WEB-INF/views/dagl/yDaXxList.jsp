...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/dagl/yDaXx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="档案信息管理"> 
	<a href="<%=path%>/dagl/YdaXx/DaXxPage" target="content" onfocus="this.blur()"><span>档案信息管理</span></a>
	</li>
</ul>
</div>
