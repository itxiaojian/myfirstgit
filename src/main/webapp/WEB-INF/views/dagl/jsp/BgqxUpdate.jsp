 ...
 $(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/dagl/YdaBgqx/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
	...
	<div class="wrapper">
		<div class="panel">
			<form action="" class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
				<c:forEach var="bgqxxx" items="${bgqxxx}" varStatus="obj">
			    <input type="hidden" name="id" id="id" value="${bgqxxx.id }">
			      ...
			      <div class="panel-body">
					...
					<div class="col-sm-10">
						<%-- <input class="form-control" type="hidden"name="id" id="id" value="${bgqxxx.id }"
						style="width:400%;height:30px;"> --%>
						<input class="form-control" name="lmmc" id="lmmc"  value="${bgqxxx.lmmc }"
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="damj"  value="${bgqxxx.damj }" style="width:400%;height:30px;" >
						<option selected="selected">${bgqxxx.damj }</option>
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="bgqx" value="${bgqxxx.bgqx}" style="width:400%;height:30px;" >
						<option selected="selected">${bgqxxx.bgqx }</option>
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
							<textarea class="form-control" type="text"  name="bz" style="width: 400%;height: 80px;">${bgqxxx.bz }</textarea>
					</div>
				</div>
