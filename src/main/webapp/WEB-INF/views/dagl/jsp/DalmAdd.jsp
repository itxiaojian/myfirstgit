...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/dagl/YdaLmgl/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
	...
	<div class="wrapper">
		...
		<header class="panel-heading"></header>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="lmmc" style="width:100%; height:28px;" id="lmmc" required data-msg-required="类目名称不可空" minlength="1" data-msg-minlength="类目名称不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">类目级别：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="lmjb" style="width:100%;height:28px;" id="lmjb">
				</div>
				<label class="col-sm-2 col-sm-2 control-label">所属机构编号：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="ssjgid" style="width:100%;  height:28px;" id="ssjgid">
					</div>
			</div>
			...
			<label class="col-sm-2 col-sm-2 control-label">类目排序：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="lmpx" style="width:100%;  height:28px;" id="lmpx"
						data-rule-number="true"  data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式"   placeholder="请输入数字格式">
					</div>
			  
					<label class="col-sm-2 col-sm-2 control-label">一级类目：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="yjlmid" style="width:100%;  height:28px;" id="yjlmid">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">上级类目：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="sjlmid" style="width:100%;  height:28px;" id="sjlmid">
				</div>
			</div>
			<div class="panel-body">
					<label class="col-sm-2 col-sm-2 control-label">管理员编号：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="flyid" style="width:100%;  height:28px;" id="glyid">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">管理员姓名：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="glyxm" style="width:100%;  height:28px;" id="glyxm">
				</div>
				
				<label class="col-sm-2 col-sm-2 control-label">创建人编号：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="cjrid" style="width:100%;  height:28px;" id="cjrid">
					</div>
			</div>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="kckrid" style="width:100%;  height:28px;" id="kckrid">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">可查看人姓名：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="kckrxm" style="width:100%; height:28px;" id="kckrxm" >
				</div>
				<label class="col-sm-2 col-sm-2 control-label">创建人姓名：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="cjrxm" style="width:100%;  height:28px;" id="cjrxm" required data-msg-required="创建人不可空" minlength="1" data-msg-minlength="创建人不可空">
				</div>
			</div>
			<div class="panel-body">
				 <label class="col-sm-2 col-sm-2 control-label">所属机构名称：</label>
				<div class="col-sm-10" style="top: 2px;">
					 <input class="easyui-combotree" type="text" id="ssjgmc" name="ssjgmc" value=" " style="padding-bottom: 2px;width: 221%;" required data-msg-required="不可空" minlength="1" data-msg-minlength="不可空">
				</div>	
			</div>
