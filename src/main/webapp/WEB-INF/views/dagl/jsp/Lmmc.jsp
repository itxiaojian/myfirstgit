              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <form action="<%=path%>/dagl/YdaBgqx/Lmmc" id="myForm" style="margin-top: 7px;" method="post">
                          	  <span style="float:left; margin-top: 7px;margin-right: 10px; margin-left: 32px;font-weight:900;">类目名称:</span>
                          ...
                          <table class="table table-striped table-advance table-hover" style="margin-top: 8px;border-top: 2px solid #ddd;">
                              ...
                              <tbody>
                              <c:forEach var="Lmmc" items="${Lmmc}" varStatus="obj">
							  <tr>
							  	  <td style="display:none;"><input type="hidden" name="id" value="${Lmmc.id }"/></td>
                                  <td><input type="hidden" name="bzbh" value="${Lmmc.lmmc }"/>${Lmmc.lmmc }</td>
                                  <td>
                                 	  <label class="label_check" for="checkbox-02">
	                                 	<a href="javascript:void(0);" class="btn btn-primary" onClick="save ('${Lmmc.id}','${Lmmc.lmmc }');">提交</a>
									  </label>
                                  </td>
                              </tr>
                              </c:forEach>
...
<%--  function save(id,viewId){
			location.href="<%=path%>/dagl/YdaBgqx/bgqxAddView?ids="+id+"&id="+viewId;
 }; --%>
 
 
 function save(id,lmmcmc){
     window.opener.$("#lmmc").val(lmmcmc);
     window.opener.$("#lmmcmc").val(id);
     self.close();
 };
</script> 
