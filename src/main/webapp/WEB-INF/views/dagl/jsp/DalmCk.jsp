		...
		<div class="panel">
			<form action="" class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
				...
				<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value="${sgzxx.sgzbh }"  name="sgzbh" style="width:100%;" >
					</div>
					<label class="col-sm-2 col-sm-2 control-label">人员编号：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${sgzxx.rybh }" name="rybh" style="width:100%;" >
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${sgzxx.cplx }" name="cplx" style="width:100%;" >
				</div>
				<label class="col-sm-2 col-sm-2 control-label">有效期：</label>
				<div class="col-sm-10">
					<input class="form-control Wdate"  type="text" value="${sgzxx.yxq }" name="yxq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:100%;" >
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" value="${sgzxx.zcid }"  name="zcid" style="width:100%;">
				</div>
			</div>
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">所属科室名称：</label>
				<div class="col-sm-10">
					<!-- <input id="ks_id" name="ks_id" class="easyui-combotree" value="1" style="width:248px;height: 34px;"/> -->
					     <input class="easyui-combotree" type="text" id="ks_id" name="ks_id" value="" style="width:170%;height:20%">
				</div>
			</div>
			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">可操作设备：</label>
				<div class="col-sm-10">
					<textarea class="form-control" truetype="textarea"  name="kczsb" rows="3" style="width:280%; height:120px;">${sgzxx.bz }</textarea>
				</div>
			</div>
			<div class="panel-body">
			<label class="col-sm-2 col-sm-2 control-label" style="left: 90px; width:20%">（设备之间用英文逗号隔开）</label>
                </div>

			<div class="panel-body">
				<label class="col-sm-2 col-sm-2 control-label">备注：</label>
				<div class="col-sm-10">
					<textarea class="form-control"  truetype="textarea"  name="bz" rows="3" style="width:280%; height:120px;">${sgzxx.bz }</textarea>
				</div>
			</div>
			<div style="text-align: center">
				<div class="panel-body"  style="padding-left: 0px; padding-right: 181px;">
					<input class="btn btn-success" value="提交" type="button" onclick="update(0);">
