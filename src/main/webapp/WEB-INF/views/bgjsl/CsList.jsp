...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/bgjsl/CsList.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="考核参数设置"> 
	<a href="<%=path%>/bgjsl/ListPage" target="content" onfocus="this.blur()"><span>考核参数设置</span></a>
	</li>
</ul>
</div>
