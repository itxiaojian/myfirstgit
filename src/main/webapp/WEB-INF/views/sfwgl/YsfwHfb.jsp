...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sfwgl/hfb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="回复信息">
	<a href="<%=path%>/sfwgl/YsfwFwxx/HfbPage" target="content" onfocus="this.blur()"><span>回复信息</span></a>
	</li>
</ul>
</div>
