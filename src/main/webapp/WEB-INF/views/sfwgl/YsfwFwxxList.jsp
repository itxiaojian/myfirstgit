...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sfwgl/fwxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="我的发文">
	<a href="<%=path%>/sfwgl/YsfwFwxx/FwxxPage" target="content" onfocus="this.blur()"><span>我的发文</span></a>
	</li>
</ul>
</div>
