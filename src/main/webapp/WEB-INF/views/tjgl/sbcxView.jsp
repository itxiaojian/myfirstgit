...
<div style="display:none;">
	<ul class="tab-menu tab" id="tabMenuID_">
		<li class="tab-selected" title="设备查询">
			<a href="<%=path%>/tjgl/sbcx/openPage" target="content" onfocus="this.blur()"><span>设备查询</span></a>
		</li>
	</ul>
</div>
<section id="container" >
	...
	<section id="main-content1">
		<section class="wrapper1">
			<!-- page start-->
			<section class="panel">
				<header class="panel-heading"><a href="<%=path%>/tjgl/sbcx/openPage" target="content" onfocus="this.blur()"><span>设备查询</span></a></header>
...
<!-- 							</select> -->
				...
				<div class="panel-body" style="margin-top: 220px;">
