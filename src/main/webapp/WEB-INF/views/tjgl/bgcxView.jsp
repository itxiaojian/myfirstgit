...
<!--     <link rel="stylesheet" href="css/owl.carousel.css" type="text/css"> -->
  ...
  <div style="display:none;">
	<ul class="tab-menu tab" id="tabMenuID_">
		<li class="tab-selected" title="报告查询">
		<a href="<%=path%>/tjgl/bgcx/openPage" target="content" onfocus="this.blur()"><span>报告查询</span></a>
		</li>
	</ul>
  </div>
  <section id="container" >
      ...
      <section id="main-content1">
          <section class="wrapper1" style="padding-bottom: 0px; padding-top: 10px;">
              <!-- page start-->
              <section class="panel" style="margin-bottom: 0px;">
<%--                   <header class="panel-heading"><a href="<%=path%>/tjgl/bgcx/openPage" target="content" onfocus="this.blur()"><span>报告查询</span></a></header> --%>
				  <div style="padding: 15px;">
						...
						<input type="hidden" id="dqsj" value="<%=enddate%>">
							...
							<label style="margin-left: 20px;">属性：</label>
...
<!-- 								    <option value="BZR">编制人</option> -->
<!-- 								    <option value="SHR">审核人</option> -->
<!-- 								    <option value="XGJDRY">批准人</option> -->
<!-- 								    <option value="QSR">签收人</option> -->
<%-- 								<c:forEach  var="data" items="${zdmc1}" varStatus="obj" begin="4" end="108"> --%>
<%-- 									<option value="${data.code}">${data.name}</option> --%>
<%-- 								</c:forEach> --%>
							</select>
							<label style="margin-left:20px;">条件：</label>
...
<!-- 							</select> -->
						...
						<div class="row" style="width:50%;float:left;margin-left: 3%;">
							<div class="col-xs-5">
								<select name="from" id="multiselect" class="form-control" size="10" multiple="multiple" style="height: 203px;border: 1px solid #47474d;">
									<c:forEach  var="data" items="${zdmc1}" varStatus="obj" >
									    <option value="${data.code}">${data.name}</option>
								    </c:forEach>
<!-- 								        <option value="BZR">编制人</option> -->
...
<%-- 								    </c:forEach> --%>
                  ...
                  <div class="panel-body" style="margin-top: 200px;padding-bottom: 0px; padding-top: 0px; padding-right: 10px;">
                        <div class="adv-table" id="Div1">
                            <div id="Div7" style="width: 1300px;overflow-x: hidden;">
							</div>
							<div id="Div6" style="width:1300px; overflow: auto; height: 333px;" onscroll="divld()">
							</div>
<!-- 							<b style="color:red;">周末、法定假日未计入报告状态</b> -->
							<div id="Div4">
								<div id="table_length" class="dataTables_length" style="float:left;margin-top: 6px;padding-bottom: 0px; padding-top: 0px;">
									<label>
										每页显示
										<select class="form-control" name="size" size="1" aria-controls="table" id="size" onchange="getValue();" style="padding: 0px;">
								...
								<div id="Div5" class="Div5">
									<div id="table_info" class="dataTables_info" style="float:left;margin-top: 6px; padding-bottom: 0px; padding-top: 0px;padding-bottom: 0px; padding-top: 0px;">显示第 0 到 0条 共0条</div>
									<div id="table_paginate" class="dataTables_paginate paging_two_button" style="float:left;margin-top: 6px; padding-top: 0px; padding-bottom: 0px;padding-bottom: 0px; padding-top: 0px;">
    ...
    <script type="text/javascript">
    	...
    	// 这段服务器端得部分可以用EL和JSTL代替
    	bgfsfszdzList.push("<%=currentValue.get("zdmc")%>");
    	...
    	// 这段服务器端得部分可以用EL和JSTL代替
    	ypjyztzdzList.push("<%=currentValue.get("zdmc")%>");
    ...
    <script type="text/javascript" src="<%=path%>/resources/js/tjgl/bgcx.js"></script>
