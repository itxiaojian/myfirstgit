...
// 		LODOP.ADD_PRINT_URL(30,20,746,"95%",'YpLzdPage?ypbh='+ypbh);
		LODOP.ADD_PRINT_URL(30,20,746,"95%","URL:"+window.location.host+"/test/testWordOnLine");
// 			LODOP.ADD_PRINT_URL(30,20,746,"95%",'YpLzdPage?ypbh=2015DQ00003');
		LODOP.SET_PRINT_STYLEA(0,"HOrient",3);
		LODOP.SET_PRINT_STYLEA(0,"VOrient",3);
		//	LODOP.SET_SHOW_MODE("MESSAGE_GETING_URL",""); //该语句隐藏进度条或修改提示信息
		//	LODOP.SET_SHOW_MODE("MESSAGE_PARSING_URL","");//该语句隐藏进度条或修改提示信息
		alert(window.location.host+"/test/testWordOnLine");
		LODOP.PREVIEW();
...
// 		LODOP.ADD_PRINT_HTML(20,13,762,510,"URL:"+window.location.host+"/test/testWordOnLine");
// // 		LODOP.ADD_PRINT_IMAGE(563,31,352,222,"URL:"+window.location.host+":"+window.location.port+"/test/testWordOnLine");
// // 		LODOP.ADD_PRINT_IMAGE(554,408,362,241,"URL:"+window.location.host+":"+window.location.port+"/test/testWordOnLine");
// 		LODOP.SET_PRINT_STYLEA(0,"Stretch",1);
