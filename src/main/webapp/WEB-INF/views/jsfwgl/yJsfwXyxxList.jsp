...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jsfwgl/yJsfwXyxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="技术服务管理"> 
	<a href="<%=path%>/jsfwgl/YjsfwXyxx/JsfwXyxxPage" target="content" onfocus="this.blur()"><span>技术服务管理</span></a>
	</li>
</ul>
</div>
