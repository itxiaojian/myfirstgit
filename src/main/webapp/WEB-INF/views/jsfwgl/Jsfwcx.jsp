...
<div style="display:none;">
	<ul class="tab-menu tab" id="tabMenuID_">
		<li class="tab-selected" title="技术服务查询">
			<a href="<%=path%>/jsfwgl/jsfwcx/openPage" target="content" onfocus="this.blur()"><span>技术服务查询</span></a>
		</li>
	</ul>
</div>
<section id="container" >
	...
	<section id="main-content1">
		<section class="wrapper1">
			<!-- page start-->
			<section class="panel">
				<header class="panel-heading"><a href="<%=path%>/jsfwgl/jsfwcx/openPage" target="content" onfocus="this.blur()"><span>技术服务查询</span></a></header>
...
<script type="text/javascript">
    	...
    	<%
    	// 这段可以用EL和JSTL等方法代替
    	List<Map<String,Object>> xyks=(List)request.getAttribute("xyks");
    	for (Map<String,Object> currentValue : xyks) {%>
    	...
    	// 这段服务器端得部分可以用EL和JSTL代替
    	jyksidList.push("<%=currentValue.get("id")%>");
    	jybmmcList.push("<%=currentValue.get("bmmc")%>");
    	<% } %>

    	<%
    	// 这段可以用EL和JSTL等方法代替
    	List<Map<String,Object>> fkfs=(List)request.getAttribute("fkfs");
    	for (Map<String,Object> currentValue : fkfs) {%>
    	// 这段服务器端得部分可以用EL和JSTL代替
    	fkfszdzList.push("<%=currentValue.get("zdz")%>");
    	fkfszdmcList.push("<%=currentValue.get("zdmc")%>");
    	<% } %>
    </script>
<script type="text/javascript" src="<%=path%>/resources/js/jsfwgl/yjsfwcx.js"></script>
