...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/kygl/yKyXxgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="信息管理"> 
	<a href="<%=path%>/kygl/YkyXxgl/KyXxglPage" target="content" onfocus="this.blur()"><span>信息管理</span></a>
	</li>
</ul>
</div>
