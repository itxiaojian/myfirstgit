...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/kygl/yKyCggl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="成果管理"> 
	<a href="<%=path%>/kygl/YkyCggl/KyCgglPage" target="content" onfocus="this.blur()"><span>成果管理</span></a>
	</li>
</ul>
</div>
