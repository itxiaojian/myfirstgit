...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/kygl/YkyXxgl/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
<body>
		...
		<div class="panel">
			...
			<div class="panel-body">
					...
					<div class="col-sm-10" >
						<input class="form-control" type="text"  style="width:100%;height: 30px;" name="kybh" required data-msg-required="科研编号不可空" minlength="1" data-msg-minlength="科研编号不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label"  >科研名称：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" name="kymc" style="width:100%;height: 30px;" required data-msg-required="科研名称不可空" minlength="1" data-msg-minlength="科研名称不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >开始时间：</label>
					<div class="col-sm-10" >
						<input class="form-control Wdate" type="text" style="width:100%;height: 30px;" name="kssj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</div>
			</div>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control Wdate" type="text"  style="width:100%;height: 30px;" name="jssj"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >参与人员：</label>
					<div class="col-sm-10" >
						<input class="form-control" type="text"  name="cyry" style="width:100%;height: 30px;">
					</div>
