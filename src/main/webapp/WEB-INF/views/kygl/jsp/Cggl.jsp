...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/kygl/YkyCggl/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<label class="col-sm-2 col-sm-2 control-label" >开始时间：</label>
				 <div class="col-sm-10" >
						<input class="form-control Wdate"  style="width:100%;height:28px;" type="text"  name="kssj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" required data-msg-required="时间必填" minlength="4" data-msg-minlength="时间必填">
				 </div>
		  </div>
			...
			<div class="panel-body" >
			       <label class="col-sm-2 col-sm-2 control-label"  >结束时间：</label>
					<div class="col-sm-10">
						<input class="form-control Wdate" style="width:100%;height:28px;"  type="text" name="jssj" style="margin-top: 6px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" required data-msg-required="时间必填" minlength="4" data-msg-minlength="时间必填">
					</div>
					...
					<div class="col-sm-10" >
						<input class="form-control" type="text"  name="cglx" style="width:100%;height:28px;">
					</div>
			</div>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10" style="margin-top: 3px;">
						<input id="ssks" name="ssks" class="easyui-combotree"  style="padding-bottom: 2px; width: 221%;">
					</div>
			</div>
           ...
           <div class="panel-body" >
			...
			<div style="text-align: center" >
				    <div class="form-group" style="margin-left: -300px; margin-top: 46px;width:150%;">
