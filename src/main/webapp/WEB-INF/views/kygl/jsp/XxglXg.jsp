...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/kygl/YkyXxgl/update";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
<body>
		...
		<div class="panel">
			...
			<c:forEach var="xxgl" items="${xxgl}" varStatus="obj">
			<input type="hidden" id="id" name="id" value="${xxgl.id }">
			<input type="hidden" id="ksbh" name="ksbh" value="${xxgl.ks_id }">
			
			<div class="panel-body">
					<label class="col-sm-2 col-sm-2 control-label" >科研编号：</label>
					<div class="col-sm-10" >
						<input class="form-control" type="text"  style="width:100%;height: 30px;" name="kybh"  value="${xxgl.kybh }" required data-msg-required="科研编号不可空" minlength="1" data-msg-minlength="科研编号不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label"  >科研名称：</label>
					<div class="col-sm-10">
						<input class="form-control" type="text" name="kymc" value="${xxgl.kymc }" style="width:100%;height: 30px;" required data-msg-required="科研名称不可空" minlength="1" data-msg-minlength="科研名称不可空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >开始时间：</label>
					<div class="col-sm-10" >
						<input class="form-control Wdate" type="text" value="${xxgl.kssj }" style="width:100%;height: 30px;" name="kssj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</div>
			</div>
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control Wdate" type="text" value="${xxgl.jssj }" style="width:100%;height: 30px;" name="jssj"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >参与人员：</label>
					<div class="col-sm-10" >
						<input class="form-control" type="text"  name="cyry" style="width:100%;height: 30px;" value="${xxgl.cyry }">
					</div>
					<label class="col-sm-2 col-sm-2 control-label"  >所属科室：</label>
					<div class="col-sm-10" style="margin-top: 3px;" >
						<input id="ks_id" name="ks_id" class="easyui-combotree" value="${xxgl.ksmc }" style="padding-bottom: 2px; width: 221%;">
					</div>
			</div>
            <div class="panel-body">
					...
					<div class="col-sm-13" >
						<textarea class="form-control ckeditor textarea" rows="6" name="kyxmnr"   
							truetype="textarea" style="width:99.5%;"  required data-msg-required="科研项目内容长度不低于10" minlength="10" data-msg-minlength="科研项目内容长度不低于10">${xxgl.kyxmnr }</textarea>
					</div>
			</div>
			<div class="panel-body">
					...
					<div class="col-sm-13">
						<textarea class="form-control ckeditor textarea" rows="6" name="bz"   
							truetype="textarea" style="width:99.5%;"  required data-msg-required="科研项目内容长度不低于10" minlength="10" data-msg-minlength="科研项目内容长度不低于10">${xxgl.bz }</textarea>
					</div>
			</div>

			<div style="text-align: center">
				    <div class="form-group" style="margin-left: -278px; margin-top: 60px;width:150%;">
