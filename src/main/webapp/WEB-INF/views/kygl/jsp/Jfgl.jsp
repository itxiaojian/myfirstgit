...
$(function(){
	...
	$("#myForm").validate({
		submitHandler: function() {
          ...
          msg = "确定要提交？";
          if (confirm(msg)) {
              var url = "<%=path%>/kygl/YkyJfgl/save";
              $.ajax({
                  cache: true,
                  type: "POST",
                  url: url,
...
<body>
		...
		<div class="panel" style="text-align: center">
			...
			<div class="panel-body">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" value=""  name="kybh" style="width:100%; height:28px;" id="kybh" required data-msg-required="不能为空" minlength="1" data-msg-minlength="不能为空">
					</div>
					<label class="col-sm-2 col-sm-2 control-label">科研名称：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" value="" name="kymc" style="width:100%;height:28px;" id="kymc" required data-msg-required="不能为空" minlength="1" data-msg-minlength="不能为空">
				</div>
				<label class="col-sm-2 col-sm-2 control-label" >立项时间：</label>
					<div class="col-sm-10" >
						<input class="form-control Wdate" type="text" style="width:100%;height:28px;"  name="lxsj" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" required data-msg-required="时间必填" minlength="1" data-msg-minlength="时间必填">
					</div>
			</div>
			...
			<div class="panel-body" >
				   <label class="col-sm-2 col-sm-2 control-label" >合同时间：</label>
					<div class="col-sm-10">
						<input class="form-control Wdate" type="text" name="htsj" style="width:100%;height:28px;"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" required data-msg-required="时间必填" minlength="1" data-msg-minlength="时间必填">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >参与人员：</label>
					<div class="col-sm-10" >
						<input class="form-control" type="text"  name="cyry" style="width:100%;height:28px;">
					</div>
					<label class="col-sm-2 col-sm-2 control-label" >经费金额：</label>
					<div class="col-sm-10" >
						<input class="form-control" type="text"  name="jfje" style="width:100%;height:28px;">
					</div>
			</div>
			...
			<div class="panel-body" >
					...
					<div class="col-sm-10">
						<input class="form-control Wdate" type="text" style="width:100%;height:28px;" name="bksj" style="margin-top: 6px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" required data-msg-required="时间必填" minlength="1" data-msg-minlength="时间必填">
					</div>
					<label class="col-sm-2 col-sm-2 control-label"  >所属科室：</label>
					<div class="col-sm-10" >
						<input id="ks_id" name="ks_id" class="easyui-combotree" value="${jfgl.ks_id }" style="padding-bottom: 2px; width: 221%;">
					</div>
			</div>
            ...
            <div class="panel-body" >
					...
					<div class="col-sm-13">
						<textarea class="form-control ckeditor textarea" rows="6" name="kyxmnr"   
							truetype="textarea" style="width:99.5%; "></textarea>
					</div>
			</div>
			 <div class="panel-body" >
