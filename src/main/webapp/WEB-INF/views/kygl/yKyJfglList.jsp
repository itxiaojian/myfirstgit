...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/kygl/yKyJfgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="经费管理"> 
	<a href="<%=path%>/kygl/YkyJfgl/KyJfglPage" target="content" onfocus="this.blur()"><span>经费管理</span></a>
	</li>
</ul>
</div>
