...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/rzcpgl/rzCpxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="产品信息">
	<a href="<%=path%>/rzcpgl/YRzCpxx/CpxxPage" target="content" onfocus="this.blur()"><span>产品信息</span></a>
	</li>
</ul>
</div>
