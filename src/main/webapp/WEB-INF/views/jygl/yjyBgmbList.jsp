...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgmb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="检验报告模版">
	<a href="<%=path%>/jygl/YjyBgmb/BgmbPage" target="content" onfocus="this.blur()"><span>检验报告模版</span></a>
	</li>
</ul>
</div>
