...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgbz.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告编制信息">
	<a href="<%=path%>/jygl/YjyBgxx/BgbzPage" target="content" onfocus="this.blur()"><span>报告编制信息</span></a>
	</li>
</ul>
</div>
