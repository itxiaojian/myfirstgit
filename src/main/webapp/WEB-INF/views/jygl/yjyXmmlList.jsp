...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyXmml.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="检验项目目录">
	<a href="<%=path%>/jygl/YjyXmml/XmmlPage" target="content" onfocus="this.blur()"><span>检验项目目录</span></a>
	</li>
</ul>
</div>
