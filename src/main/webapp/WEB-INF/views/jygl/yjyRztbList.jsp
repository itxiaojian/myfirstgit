...
<head>
	...
	<script type="text/javascript">
		...
		var width = $(window).width();
		    var tabs = new Ext.TabPanel({
		        ...
		        items:[ {
		                title: '认证图标', 
		                 html:'<iframe src="/zjyw/jygl/YjyRztb/scRztbView" width="100%" height="100%" style="border:0;"></iframe>',
		                 id : 'tp_tab'
		            },
		             /* {
		                title: '语音', 
  ...
  <body>
		...
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="素材管理"><a
				href="<%=path%>/jygl/YjyRztb/rztbView" target="content"
				onfocus="this.blur()"><span>认证图标</span></a></li>
		</ul>
	</div>
