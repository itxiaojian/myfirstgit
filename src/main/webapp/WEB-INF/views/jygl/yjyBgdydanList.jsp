...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgdydan.js"></script>
<style>
.hide{display:none;}
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告打印">
	<a href="<%=path%>/jygl/YjyBgxx/BgdydanPage" target="content" onfocus="this.blur()"><span>报告打印</span></a>
	</li>
</ul>
</div>
