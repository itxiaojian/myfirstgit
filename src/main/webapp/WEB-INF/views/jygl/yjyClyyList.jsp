...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyClyy.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="常用检验结论用语">
	<a href="<%=path%>/jygl/YjyClyy/ClyyPage" target="content" onfocus="this.blur()"><span>常用检验结论用语</span></a>
	</li>
</ul>
</div>
