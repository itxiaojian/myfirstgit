...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgdy.js"></script>
<style>
.hide{display:none;}
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告多次打印">
	<a href="<%=path%>/jygl/YjyBgxx/BgdyPage" target="content" onfocus="this.blur()"><span>报告多次打印</span></a>
	</li>
</ul>
</div>
