...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgxx.js"></script>
<%-- 	<script type="text/javascript" src="<%=path%>/resources/js/jygl/IpasJxdxCkzh.js"></script> --%>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/jygl/YjyBgxx/BgxxPage" target="content" onfocus="this.blur()"><span>报告查询</span></a>
	</li>
</ul>
</div>
