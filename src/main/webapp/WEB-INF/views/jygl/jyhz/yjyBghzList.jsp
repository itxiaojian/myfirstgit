...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBghz.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告汇总信息">
	<a href="<%=path%>/jygl/YjyBghz/BghzPage" target="content" onfocus="this.blur()"><span>报告汇总信息</span></a>
	</li>
</ul>
</div>
