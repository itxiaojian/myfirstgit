...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyYsjl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告原始记录">
	<a href="<%=path%>/jygl/YjyYsjl/YsjlPage" target="content" onfocus="this.blur()"><span>报告原始记录</span></a>
	</li>
</ul>
</div>
