...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jySbxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="检验设备信息">
	<a href="<%=path%>/jygl/YjySbxx/SbxxPage" target="content" onfocus="this.blur()"><span>检验设备信息</span></a>
	</li>
</ul>
</div>
