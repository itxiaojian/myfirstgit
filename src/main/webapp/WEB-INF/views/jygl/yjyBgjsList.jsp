...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgjs.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告解锁信息">
	<a href="<%=path%>/jygl/YjyBgxx/BgjsPage" target="content" onfocus="this.blur()"><span>报告解锁信息</span></a>
	</li>
</ul>
</div>
