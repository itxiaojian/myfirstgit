...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyJyxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="检验信息">
	<a href="<%=path%>/jygl/YjyJyxx/JyxxPage" target="content" onfocus="this.blur()"><span>检验信息</span></a>
	</li>
</ul>
</div>
