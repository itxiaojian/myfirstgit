...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/QfzList.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="整体报告打印">
	<a href="<%=path%>/jygl/YjyBgxx/QfzPage" target="content" onfocus="this.blur()"><span>整体报告打印</span></a>
	</li>
</ul>
</div>
