...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyNwgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="院内委托管理">
	<a href="<%=path%>/jygl/YjyNwgl/nwglPage" target="content" onfocus="this.blur()"><span>院内委托管理</span></a>
	</li>
</ul>
</div>
