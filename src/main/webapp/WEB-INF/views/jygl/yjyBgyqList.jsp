...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgyq.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告延期">
	<a href="<%=path%>/jygl/YjyBgxx/BgyqPage" target="content" onfocus="this.blur()"><span>报告延期</span></a>
	</li>
</ul>
</div>
