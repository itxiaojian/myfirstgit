              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <input type="text" name="ypid" id="ypid" value="${id }">
							  ...
							  <tr>
                                  ...
                                  <td>
                                 	  <label class="label_check" for="checkbox-02">
	                                 	<a href="javascript:void(0);" class="btn btn-primary" onClick="save('${jybz.id}');">提交</a>
									  </label>
...
<script  type="text/javascript">
 ...
 function save(jybzid){
	 var ypid = $("#ypid").val();
	 location.href="<%=path%>/jygl/YjyJyxx/ypjy?jybzid="+jybzid+"&ypid="+ypid;
 };
</script> 
