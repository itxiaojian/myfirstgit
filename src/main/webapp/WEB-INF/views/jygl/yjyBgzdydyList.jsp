...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jygl/jyBgzdydy.js"></script>
<style>
.hide{display:none;}
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告自定义打印">
	<a href="<%=path%>/jygl/YjyBgxx/BgzdydyPage" target="content" onfocus="this.blur()"><span>报告自定义打印</span></a>
	</li>
</ul>
</div>
