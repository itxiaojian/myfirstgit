...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yhgl/SysYh.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/yhgl/SysYh/SysYhPage" target="content" onfocus="this.blur()"><span>人员管理</span></a>
	</li>
</ul>
</div>
