...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/yhgl/YdjYh.js"></script>
...
// 		        items:[ {
// 		                 html:'<iframe src="/zjyw/yhgl/SysYh/scDzqmView" width="100%" height="100%" style="border:0;"></iframe>',
// 		                 id : 'tp_tab'
// 		            },
		             /* {
		                title: '语音', 
		                html:'<iframe src="/wxpt/wxauth/materialmgr/voiceMaterialView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'yy_tab'
		            } ,
		            {
		                title: '视频', 
		                html:'<iframe src="/wxpt/wxauth/materialmgr/videoMaterialView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'sp_tab'
		            } ,
		            {
		                title: '图文消息',   
		                html:'<iframe src="/wxpt/wxauth/materialmgr/tuwenView" width="100%" height="100%" style="border:0;"></iframe>' ,
		                id : 'tw_tab'
		            }  */
// 		        ]
// 		    });
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="用户管理项"> 
	<a href="<%=path%>/yhgl/SysYh/YdjYhPage" target="content" onfocus="this.blur()"><span>预登记账号管理</span></a>
	</li>
</ul>
</div>
