...
function update() {
	...
	msg="确定要提交？";
	if (confirm(msg)) {
		var url = "<%=path%>/ydmb/YJyYdmb/save";
		$.ajax({
			cache : true,
			type : "POST",
			url : url,
...
<body onload="load();">
	...
	<!-- <header class="panel-heading" style="padding-left: 650px;">样品信息</header> -->
		<div class="panel-body">
			...
			<%-- 	<div class="form-group" style="padding-bottom: 10px; padding-left: 0px; width: 100%; margin-bottom: 0px;">
					<label class="col-sm-2 col-sm-2 control-label" style="margin-top: 15px; border-left-width: 10px; padding-top: 14px; padding-left: 13px; width:6.5%;" >模板分类：</label>
				<div class="col-sm-10">
					<select class="form-control input-lg m-bot15" name="mbfl" style="font-size:14px; height:25px;margin-top:22px;" >
						<option selected="selected">${ydmb.mbfl }</option>
				<c:forEach var="mbfl" items="${mbfl}" varStatus="obj">
						<option>${mbfl.zdz }</option>
				</c:forEach>
					</select>
                </div>
               </div> --%>
					...
					<div class="form-group"
						...
						<label class="col-sm-2 col-sm-2 control-label"
							style="margin-top: 15px; border-left-width: 10px; padding-top: 14px; padding-left: 13px; width: 80px;">模板分类：</label>
					...
					<div class="form-group" style="padding-bottom: 10px; padding-left: 0px; width: 100%; margin-bottom: 0px;">
					 <label class="col-sm-2 col-sm-2 control-label" style="margin-top: 15px; border-left-width: 10px; padding-top: 14px; padding-left: 13px; width: 80px;" >部门名称：</label>
                            <div class="col-sm-10" style="margin-top: 21px;">
                              <input id="bmmc" name="bmmc" class="easyui-combotree" value=""
					...
					<div class="form-group" style="padding-bottom: 10px; padding-left: 0px; width: 100%; margin-bottom: 0px;left:-75px;">
						...
						<label class="col-sm-2 col-sm-2 control-label" style="margin-top: -4px; border-left-width: 10px; padding-top: 14px; padding-left: 13px; width: 80px;">封面：</label>
							<div class="col-sm-10">
								<input class="form-control" type="text" id="fm_id" name="fm_id">
						...
						<div class="form-group" style="padding-bottom: 10px; padding-left: 0px; width: 100%; margin-bottom: 0px;">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" id="sy_id" name="sy_id">
						...
						<div class="form-group" style="padding-bottom: 10px; padding-left: 0px; width: 100%; margin-bottom: 0px;">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" id="fy_id" name="fy_id">
