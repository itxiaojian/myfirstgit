...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ydmb/jyYdmb.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="模板设置">
	<a href="<%=path%>/ydmb/YJyYdmb/YdmbPage" target="content" onfocus="this.blur()"><span>模板设置</span></a>
	</li>
</ul>
</div>
