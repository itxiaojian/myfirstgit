...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/jybzgl/yjyBzgl.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		...
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="检验标准管理"><a
				href="<%=path%>/jybzgl/jybzglPage" target="content"
				onfocus="this.blur()"><span>检验标准管理</span></a></li>
		</ul>
	</div>
