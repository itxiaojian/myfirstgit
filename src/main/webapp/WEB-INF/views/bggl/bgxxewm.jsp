...
<h3 class="noprint" style="text-align: center;" align="center">报告信息</h3>
...
<div>
		...
		<tbody>
			<tr>
				<td colspan="2" style="text-align: left;">报告名称：${map.bgmc }</td>
			</tr>
			<tr>
				<td style="text-align: left;">报告编号：${map.bgbh }</td>
