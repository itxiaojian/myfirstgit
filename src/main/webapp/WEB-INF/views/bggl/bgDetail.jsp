...
function openypxxwin() {  
	 var bgbh = $("#bgbh").val(); 
    //window.open("ypxx?ypxx="+bgbh, "样品信息", "height=750, width=1000, toolbar =no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no") ;
	 location.href="ypxx?bgbh="+bgbh;
} 
...
<!-- 						> -->
						...
						<label class="col-sm-2 col-sm-2 control-label">
						<a class="btn btn-xs btn-success" onclick="openswpd(1,'${clyy1 }','${clyy2 }','${clyy3 }');" type="submit"> 选择常规结论用语</a>
					    </label>
					</div>
...
<%-- 							<input type="text"  class="form-control" value="${jyxx.bzpd }" name="bzpd"> --%>
						...
						<label class="col-sm-2 col-sm-2 control-label">
						<a class="btn btn-xs btn-success" onclick="openswpd(2,'${clyy1 }','${clyy2 }','${clyy3 }');" type="submit"> 选择常规结论用语</a>
					    </label>
					</div>
						<div class="form-group"  style="height: 90px;">
...
<%-- 							<input type="text" class="form-control" value="${jyxx.jyjl }" name="jyjl"> --%>
						...
						<label class="col-sm-2 col-sm-2 control-label">
						<a class="btn btn-xs btn-success" onclick="openswpd(3,'${clyy1 }','${clyy2 }','${clyy3 }');" type="submit"> 选择常规结论用语</a>
					    </label>
					</div> 
			</div>
	</div>
							...
							<tbody style="border-top: 0px;float:left;">
								<tr>
									<td style=" border-top-width: 0px; float:left;">
										...
										<div style="display: none;" id="img_${obj.count }">
											<img alt="${rztb.rzmc }" src="<%=path %>/${rztb.fjlj }/${rztb.sub }">
										</div>
									</td>
								</tr>
							</tbody>
	...
	<div style="text-align:center">
		<div class="panel-body">
			<button type="button" class="btn btn-primary"  style="width: 79px;" onClick="bianzhi();">编制报告</button>
			<button type="button" class="btn btn-primary"  style="width: 79px;" onClick="tuijian();">退检</button>
...
//     				alert($(this).val());
    	...
    	//alert($("#rztbid").val());
    	 location.href="<%=path%>/jygl/YjyBgxx/bianzhi?bgbh="+bgbh+"&jyid="+jyid+"&rztbid="+rztbid; 
    }
