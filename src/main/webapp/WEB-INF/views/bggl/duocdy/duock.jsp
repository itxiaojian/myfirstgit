...
function loadTest2(){
	document.getElementById('test2').src='<%=path%>/jygl/YjyBgxx/duocidayinsy?bgbh=<%=bgbh %>';
}
...
<!-- 	            <div class="elapsed"></div> -->
		...
		<div style="width:0px;height:0px;border-width: 0px;">
			<iframe id="test1" src="<%=path%>/jygl/YjyBgxx/duocidayinfm?bgbh=<%=bgbh %>" style="width:0px;height:0px;border-width: 0px;"></iframe>
