...
WordDocument worddoc = new WordDocument();
	...
	//页数
		...
		fmCtrl.fillDocument(request.getSession().getServletContext().getRealPath("resources/home")+"/"+"ybbgfsfy.doc", DocumentOpenType.Word);
		fmCtrl.setSaveFilePage(path+"/jygl/YjyBgxx/savePageTest?filename=ybbgfsfy");
