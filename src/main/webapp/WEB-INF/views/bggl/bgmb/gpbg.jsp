...
WordDocument worddoc = new WordDocument();
	...
	if(request.getAttribute("pages") == null){
		...
		fmCtrl.fillDocument(request.getSession().getServletContext().getRealPath("resources/home")+"/"+"gpbg.doc", DocumentOpenType.Word);
		fmCtrl.setSaveFilePage(path+"/jygl/YjyBgxx/savePageTest?filename="+bgbh+"gpbg");
