...
WordDocument worddoc = new WordDocument();
	...
	if(request.getAttribute("pages") == null){
		...
		fmCtrl.fillDocument(request.getSession().getServletContext().getRealPath("resources/home")+"/"+"gjbgfsfy.doc", DocumentOpenType.Word);
		File file=new File(request.getSession().getServletContext().getRealPath("resources/doc")+"/"+"gjbgfsfy.doc");    
		if(!file.exists())    
		{
			fmCtrl.setSaveFilePage(path+"/jygl/YjyBgxx/savePageTest?filename=gjbgfsfy");
		}
