...
WordDocument worddoc = new WordDocument();
	...
	if(request.getAttribute("pages") == null){
		...
		fmCtrl.fillDocument(request.getSession().getServletContext().getRealPath("resources/home")+"/"+"gjbgfy.doc", DocumentOpenType.Word);
		File file=new File(request.getSession().getServletContext().getRealPath("resources/doc")+"/"+"gjbgfy.doc");    
		if(!file.exists())    
		{
			fmCtrl.setSaveFilePage(path+"/jygl/YjyBgxx/savePageTest?filename=gjbgfy");
		}
