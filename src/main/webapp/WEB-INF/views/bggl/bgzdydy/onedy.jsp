...
<%
	...
	if("1".equals(request.getAttribute("ymids")) || "1,4".equals(request.getAttribute("ymids")) || 
			"1,5".equals(request.getAttribute("ymids"))){
		//封面
...
// 		}
	...
	if("2".equals(request.getAttribute("ymids"))){
		//首页
			DataRegion data2 = worddoc.openDataRegion("PO_p1");
...
// 		}
	...
	if("1,4,5".equals(request.getAttribute("ymids"))){
		//带认证章的封面
			DataRegion data1 = worddoc.openDataRegion("PO_p1");
...
// 	poCtrl1.addCustomToolButton("另存为PDF文件", "SaveAsPDF()", 1);
	...
	poCtrl1.webOpen("/zjyw/resources/home/onedy.doc", OpenModeType.docReadOnly, "");
