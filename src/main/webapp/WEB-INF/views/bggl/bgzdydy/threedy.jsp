...
<%
	...
	if("1,2,3".equals(request.getAttribute("ymids")) || "1,2,3,4".equals(request.getAttribute("ymids")) || "1,2,3,5".equals(request.getAttribute("ymids"))){
		//封面
...
// 			data3.setValue("[word]"+request.getSession().getServletContext().getRealPath("resources/doc")+"/"+bgbh+"fy"+".doc"+"[/word]");
// 		}
	}else if("1,2,3,4,5".equals(request.getAttribute("ymids"))){
		//封面
			DataRegion data1 = worddoc.openDataRegion("PO_p1");
