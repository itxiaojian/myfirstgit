...
function loadTest2(){
	...
	document.getElementById('test2').src='<%=path%>/jygl/YjyBgxx/ybbgfy?bgbh=<%=bgbh %>';
	document.getElementById('test3').src='<%=path%>/jygl/YjyBgxx/ybbgfsfy?bgbh=<%=bgbh %>';
	document.getElementById('test4').src='<%=path%>/jygl/YjyBgxx/zdydy?bgbh=<%=bgbh %>&ymids=<%=ymids %>';
}
// window.setTimeout(loadTest2,1000);

</script>
<body onload="loadTest2();">
	<div class="wrapper">
...
<!-- 	            <div class="elapsed"></div> -->
		...
		<div style="width:0px;height:0px;border-width: 0px;">
			...
			<iframe id="test4" src="" style="width:0px;height:0px;border-width: 0px;"></iframe>
		</div>
	</div>
</body>
</html>