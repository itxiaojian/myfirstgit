...
function loadTest2(){
	document.getElementById('test2').src='<%=path%>/jygl/YjyBgxx/bgcc?bgbh=<%=bgbh%>';
}

window.setTimeout(loadTest2,500);
...
<!-- 		</div> -->
		<div style="width:0px;height:0px;border-width: 0px;">
			<iframe id="test1" src="<%=path%>/jygl/YjyBgxx/pzr?bgbh=<%=bgbh%>" style="width:0px;height:0px;border-width: 0px;"></iframe>
