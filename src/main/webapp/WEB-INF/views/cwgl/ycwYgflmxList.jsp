...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwYgflmx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="员工工资薪金明细">
	<a href="<%=path%>/cwgl/YCwYgflmx/YgflmxPage" target="content" onfocus="this.blur()"><span>员工工资薪金明细</span></a>
	</li>
</ul>
</div>
