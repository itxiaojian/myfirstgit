...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwXyysf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="协议已收费">
	<a href="<%=path%>/cwgl/YcwJsfwxysf/XyysfPage" target="content" onfocus="this.blur()"><span>协议已收费</span></a>
	</li>
</ul>
</div>
