...
function save() {
	msg="确定要提交？";
	if (confirm(msg)) {
		var url2 = "<%=path%>/cwgl/YCwYgfl/save";
		$.ajax({
			cache : true,
			type : "POST",
			url : url2,
		...
		<form class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;width:100%;">
				<label class="col-sm-2 col-sm-2 control-label"  >所属科室：</label>
					<div class="col-sm-10" >
						<input id="ks_id" name="ks_id" class="easyui-combotree" value="" style="height: 34px;width: 238px;"/>
					</div>
				<label class="col-sm-2 col-sm-2 control-label">员工姓名：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="ygxm" name="ygxm">
				</div>
			</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;width:100%;">
				...
				<div class="col-sm-10">
                    ...
                    <input class="form-control Wdate" type="text" id="ssyf" name="ssyf" value="<%=enddate%>"
				...
				<div class="col-sm-10">
					<select class="form-control input-lg m-bot15" name="gzxjmc" id="gzxjmc">
                        ...
                        <c:forEach var="fllx" items="${fllx}" varStatus="obj">
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;width:100%;">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="flhj" name="flhj" />
				</div>
				<label class="col-sm-2 col-sm-2 control-label">工资薪金详情：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="gzxjxq" name="gzxjxq" />
				</div>
			</div>
			...
			<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;width:100%;">
                ...
                <div class="col-sm-13">
					<textarea class="form-control ckeditor textarea" rows="3" name="bz" truetype="textarea" ></textarea>
                </div>
			</div>
