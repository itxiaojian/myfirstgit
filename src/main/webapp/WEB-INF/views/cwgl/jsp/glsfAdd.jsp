			...
			<div style="text-align:center;margin-bottom:-2px"></div>
                <form class="form-horizontal tasi-form" name="myForm" id="myForm" method="post">
					<div class="form-group" style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 4px; width: 101%;">
						...
						<div class="col-sm-10">
						<input id="bmbh" name="bmbh" class="easyui-combotree" value=" " style="padding-bottom: 2px;  width: 221%;">
<!-- 							<select class="form-control input-lg m-bot15" name=bmbh style="padding-left: 2px;" > -->
...
<!-- 					        </select> -->
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" id="fphm" name="fphm">
						</div>
					...
					<div class="form-group" style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" id="sfxmmc" name="sfxmmc">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">收费金额（元）：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="sfje" name="sfje"> 
						</div>
<!-- 						<label class="col-sm-2 col-sm-2 control-label">缴费日期：</label> -->
<!-- 						<div class="col-sm-10"> -->
<!-- 							<input class="form-control Wdate" type="text" id="sfrq" name="sfrq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" -->
...
<!-- 						</div> -->
					...
					<div style="text-align: center">
						<div class="form-group" style="width: 90%;padding-top: 6px; margin-left: 75px;">
							<input class="btn btn-success" value="提交" type="submit" onclick="save();">
...
//提交
 function save() {
	msg="确定要提交？";
	if (confirm(msg)) {
		var url = "<%=path%>/cwgl/YcwGlbmsf/save";
		$.ajax({
			cache : true,
			type : "POST",
			url : url,
