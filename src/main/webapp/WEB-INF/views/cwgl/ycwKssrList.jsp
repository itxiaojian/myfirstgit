...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwKssr.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="科室收入">
	<a href="<%=path%>/cwgl/YCwKssr/KssrPage" target="content" onfocus="this.blur()"><span>科室收入</span></a>
	</li>
</ul>
</div>
