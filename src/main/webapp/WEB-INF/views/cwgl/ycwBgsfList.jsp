...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwBgsf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告待收费">
	<a href="<%=path%>/cwgl/YcwBgsf/BgsfPage" target="content" onfocus="this.blur()"><span>报告待收费</span></a>
	</li>
</ul>
</div>
