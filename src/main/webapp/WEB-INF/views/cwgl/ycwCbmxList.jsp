...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwCbmx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="成本明细">
	<a href="<%=path%>/cwgl/YCwCbmx/CbmxPage" target="content" onfocus="this.blur()"><span>成本明细</span></a>
	</li>
</ul>
</div>
