...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwYgfl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="员工工资薪金">
	<a href="<%=path%>/cwgl/YCwYgfl/YgflPage" target="content" onfocus="this.blur()"><span>员工工资薪金</span></a>
	</li>
</ul>
</div>
