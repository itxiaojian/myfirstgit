...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwBgysf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报告已收费">
	<a href="<%=path%>/cwgl/YcwBgsf/BgysfPage" target="content" onfocus="this.blur()"><span>报告已收费</span></a>
	</li>
</ul>
</div>
