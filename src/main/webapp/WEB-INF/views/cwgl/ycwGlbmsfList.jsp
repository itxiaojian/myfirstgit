...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwGlbmsf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="管理服务部门收费">
	<a href="<%=path%>/cwgl/YcwGlbmsf/GlbmsfPage" target="content" onfocus="this.blur()"><span>管理服务部门收费</span></a>
	</li>
</ul>
</div>
