...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwXysf.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="协议待收费">
	<a href="<%=path%>/cwgl/YcwJsfwxysf/XysfPage" target="content" onfocus="this.blur()"><span>协议待收费</span></a>
	</li>
</ul>
</div>
