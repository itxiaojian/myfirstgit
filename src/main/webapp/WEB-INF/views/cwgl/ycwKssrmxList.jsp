...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cwgl/cwKssrmx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="科室收入明细">
	<a href="<%=path%>/cwgl/YCwKssrmx/KssrmxPage" target="content" onfocus="this.blur()"><span>科室收入明细</span></a>
	</li>
</ul>
</div>
