...
function ss(){
	...
	var time=$('#search').val();
	location.href="<%=path%>/wxpt/WglXgxx/wglGzhbList1?time="+time+"&openId="+openId;
}
</script>
</head>
...
<input type="hidden" value="${openId}" id="openId" />
	<div class="main">
		...
		<div class="middle" style="padding-bottom: 2px;position: relative;">
			<h1 style="color: #0D91DE"><b>我可查看的工作汇报</b></h1>
			<div class="anniu">
		...
		<div class="bottom" style="position: relative;">
			...
			<tr>
			   <td align="center" style="height: 37px;"><B>序号</B></td>
			    <td align="center"><B>汇报类型</B></td>
			     <td align="center"><B>汇报人</B></td>
			      <td align="center"><B>汇报日期</B></td>
			        <td align="center"><B>操作</B></td>
			</tr>
			<c:forEach var="data" items="${hblist1}" varStatus="status">
			<tr>
			    ...
			    <td align="center">${data.hblxmc}</td>
			     <td align="center">${data.hbrxm }</td>
			      <td align="center">${data.hbrq}</td>
			        <td align="center"><a class="edit" href="<%=path%>/wxpt/WglXgxx/wglGzhbXq?id=${data.hbid}">详情</a></td>
			</tr>
			</c:forEach>
			</table>
			</div>
