...
function ss(){
	...
	var time=$('#search').val();
	location.href="<%=path%>/wxpt/WglXgxx/wglGzhbList?time="+time+"&openId="+openId;
}
</script>
</head>
...
<input type="hidden" value="${openId}" id="openId" />
	<div class="main">
		...
		<div class="middle" style="padding-bottom: 2px;position: relative;">
			<h1 style="color: #0D91DE"><b>我已发的工作汇报</b></h1>
			<div class="anniu">
		...
		<div class="bottom" style="position: relative;">
			...
			<c:forEach var="data" items="${hblist}" varStatus="status">
			<tr>
