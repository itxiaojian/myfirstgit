...
<body style="overflow: auto;">
	<div class="main" style="width: 100%;hight:100%">
		...
		<div class="bottom" style="width: 100%;">
               ...
               <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=0&openId=${openId}" style="text-decoration:none">
			    <p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;培训请假&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			    </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=1&openId=${openId}" style="text-decoration:none">
				<p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;加班申请&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			    </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=2&openId=${openId}" style="text-decoration:none">
				<p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;出差申请&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			   </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=3&openId=${openId}" style="text-decoration:none">
                <p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;工作请假&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			 </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=4&openId=${openId}" style="text-decoration:none">
			    <p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;外出申请&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			   </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=5&openId=${openId}" style="text-decoration:none">
			    <p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;物品采购申请&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			   </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
			    ...
			    <a href="<%=path%>/wxpt/WglXgxx/sqxx?sqlx=6&openId=${openId}" style="text-decoration:none">
			    <p style="color: black;"><b>&nbsp;&nbsp;&nbsp;&nbsp;费用报销&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></b></p>
			    </a>
			    <div>
			    <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=3>
			    </div>
