...
function ss(){
	...
	var time=$('#search').val();
	location.href="<%=path%>/wxpt/WglXgxx/wglWdsqList1?time="+time+"&openId="+openId;
}
</script>
</head>
...
<input type="hidden" value="${openId}" id="openId" />
	<div class="main">
		...
		<div class="middle" style="padding-bottom: 2px;position: relative;">
			<h1 style="color: #0D91DE"><b>需要我审批的申请</b></h1>
			<div class="anniu">
		...
		<c:forEach var="data" items="${xwdsqlist}" varStatus="status">
			<tr>
			   ...
			   <td align="center"><a class="edit" 
			    href="<%=path%>/wxpt/WglXgxx/wglWdsqXq1?id=${data.sqid}&openId=${openId}">详情</a></td>
			</tr>
		    </c:forEach>
			</table>
			</div>
