...
function ss(){
	...
	var time=$('#search').val();
	location.href="<%=path%>/wxpt/WglXgxx/wglWdsqList2?time="+time+"&openId="+openId;
}
</script>
</head>
...
<input type="hidden" value="${openId}" id="openId" />
	<div class="main">
		...
		<div class="middle" style="padding-bottom: 2px;position: relative;">
			<h1 style="color: #0D91DE"><b>抄送给我的申请</b></h1>
			<div class="anniu">
		...
		<div class="bottom" style="position: relative;">
			...
			<c:forEach var="data" items="${cswdsqlist}" varStatus="status">
			<tr>
			   ...
			   <td align="center"><a class="edit" 
			    href="<%=path%>/wxpt/WglXgxx/wglWdsqXq2?id=${data.sqid}&openId=${openId}">详情</a></td>
			</tr>
		    </c:forEach>
			</table>
			</div>
