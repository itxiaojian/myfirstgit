...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypYj.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="移交记录">
	<a href="<%=path%>/ypgl/YYpYj/yjjlPage" target="content" onfocus="this.blur()"><span>移交记录</span></a>
	</li>
</ul>
</div>
