		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
                        style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
                       <label class="col-sm-2 col-sm-2 control-label">食品名称：</label>
                       <div class="col-sm-10">
                   ...
                   <div class="form-group"
	                   ...
	                   <div class="col-sm-10">
						<select class="form-control input-lg m-bot15" name="rwly" disabled="true">
                   ...
                   <div class="form-group"
                       ...
                       <label class="col-sm-2 col-sm-2 control-label">食品生产批号：</label>
                       <div class="col-sm-10">
                   ...
                   <div class="form-group"
                       ...
                       <div class="col-sm-10">
                           <input class="form-control" type="text" id="cydd" name="cydd" value="${ypxx.cydd }" readonly="readonly">
                       </div>
                   ...
                   <div class="form-group"
                       ...
                       <div class="col-sm-10">
                           <input class="form-control" type="text" id="cydbh" name="cydbh" value="${ypxx.cydbh }" readonly="readonly" >
                       </div>
                   </div>									
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="wtlxr" name="wtlxr" value="${ypxx.wtlxr }" disabled="true">
                        </div>
					</div>
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sjhm" name="sjhm" value="${ypxx.sjhm }" disabled="true">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">委托单位邮编：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="wtyb" name="wtyb" value="${ypxx.wtyb }" disabled="true">
                        </div>
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="dh" name="dh" value="${ypxx.dh }" disabled="true">
                        </div>
					</div>
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="yb" name="yb" value="${ypxx.yb }" disabled="true">
                        </div>
						<label class="col-sm-2 col-sm-2 control-label">标称生产者：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="scdw" name="scdw" value="${ypxx.scdw }" disabled="true">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">标称生产地址：</label>
                        <div class="col-sm-10">
					...
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
                        <label class="col-sm-2 col-sm-2 control-label">标称生产联系人：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="scdwlxr" value="${ypxx.scdwlxr }" disabled="true">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">标称生产者电话：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="scdwdh" value="${ypxx.scdwdh }" disabled="true">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">标称生产者邮编：</label>
                        <div class="col-sm-10">
