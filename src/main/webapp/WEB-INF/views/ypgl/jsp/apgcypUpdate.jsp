                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scrqpc"
                                                               name="scrqpc" value="${ypxx.scrqpc }" maxlength="28" placeholder="最多输入28个字">
                                                    </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="lyr" name="lyr"
		                                                 value="${ypxx.lyr }" maxlength="8" placeholder="最多输入8个字">
		                                            </div>
                                                </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="ypsl" name="ypsl" 
		                                                 maxlength="16" placeholder="最多输入16个字" value="${ypxx.ypsl }" />
		                                            </div>
		                                        </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                               <input class="form-control" type="text" id="gclxr"
		                                                      value="${ypxx.gclxr }" name="gclxr" maxlength="8" placeholder="最多输入8个字">
		                                            </div>
		                                        </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="wtdwdz"
		                                                       name="wtdwdz" maxlength="45" placeholder="最多输入45个字" value="${ypxx.wtdwdz }">
		                                            </div>
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="sjdwdz"
		                                                       name="sjdwdz" value="${ypxx.sjdwdz }" maxlength="45" placeholder="最多输入45个字">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label" style="width: 30%; margin-left: 2%; 
		                                            	   padding-top: 0px; margin-top: 3px;">
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="scdwdz"
		                                                 name="scdwdz" value="${ypxx.scdwdz }" maxlength="45" placeholder="最多输入45个字">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label" style="width: 30%; margin-left: 2%; 
		                                            	   padding-top: 0px; margin-top: 3px;">
...
<!--                                                     </div> -->
                                                    <div class="col-sm-10">
                                                        ...
                                                        value="${ypxx.dyrq}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" disabled >
                                                        <input class="form-control Wdate" type="hidden" id="dyrq" name="dyrq" 
                                                        value="${ypxx.dyrq}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
                                                    </div>
