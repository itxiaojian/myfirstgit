		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="list" items="${list}" varStatus="obj"> 
					...
					<input class="form-control" type="hidden" id="ypyj" name="ypyj" value="${ypxx.ypyj }">
					<input class="form-control" type="hidden" id="yjzt" name="yjzt" value="${ypxx.yjzt }">
					...
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd hh24:mm:ss'})" value="${djsj }">
                                <%--收放效果开始--%>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scrqpc"
                                                               name="scrqpc" value="${ypxx.scrqpc }" placeholder="最多输入28个字" onKeyUp="checkLen(this,56)">
                                                    </div>
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入45个字" value="${ypxx.sjdwdz }">
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                                                        data-msg-mobile="请输入正确的格式" value="${ypxx.dh }">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式" 
                                                        placeholder="请输入正确的格式" minlength="6" maxlength="6" value="${ypxx.yb }">
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scdwgddh" name="scdwgddh" onKeyUp="checkLen(this,34)"  
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
										            ...
										            placeholder="最多输入160个字">${ypxx.jyxm }</textarea>
                                                    </div>
...
<!--                                                     <label class="col-sm-2 col-sm-2 control-label">待定</label>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
													...
													placeholder="最多输入120个字" onKeyUp="checkLen(this,240)" >${ypxx.bz}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
