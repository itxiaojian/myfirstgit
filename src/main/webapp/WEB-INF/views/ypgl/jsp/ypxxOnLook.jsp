			...
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
                       ...
                       <label class="col-sm-2 col-sm-2 control-label">样品移交：</label>
                       <div class="col-sm-10" style="margin-top: 5px;">
                           <label><input type="radio" name="ypyj" value="0" >未移交</label>
                           <label style="padding-left: 20px;"><input type="radio" name="ypyj" value="1">已移交</label>
                           <input type="hidden" name="yRadio" id="yRadio" value="${ypxx.ypyj }">
                       </div>
                   </div>									
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入36个字" value="${ypxx.wtdw }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入45个字" value="${ypxx.wtdwdz }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入8个字" value="${ypxx.wtlxr }" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            data-msg-mobile="请输入正确的格式" value="${ypxx.sjhm }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入17个字" value="${ypxx.wtdwgddh }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            minlength="6" maxlength="6" placeholder="请输入正确的格式" value="${ypxx.wtyb }" readonly="readonly">
                        </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入36个字" value="${ypxx.sjdw }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入45个字" value="${ypxx.sjdwdz }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入8个字" value="${ypxx.lxr }" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                            data-msg-mobile="请输入正确的格式" value="${ypxx.dh }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入17个字" value="${ypxx.sjdwgddh }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式" 
                            placeholder="请输入正确的格式" minlength="6" maxlength="6" value="${ypxx.yb }" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入36个字" value="${ypxx.scdw }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入45个字" value="${ypxx.scdwdz }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入8个字" value="${ypxx.scdwlxr }" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                            data-msg-mobile="请输入正确的格式" value="${ypxx.scdwdh }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="最多输入17个字" value="${ypxx.scdwgddh }" readonly="readonly">
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式" readonly="readonly"
