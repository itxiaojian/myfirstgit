                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10" style="margin-top: 21px;">
                                                ...
                                                <!-- <select class="form-control input-lg m-bot15"
                                                        id="zh" name="zh" required onchange="getBh();">
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control input-lg m-bot15" name="rwly" id="rwly" >
                                                	<option selected="selected" value="">请选择...</option>
                                                    <c:forEach var="rwly" items="${rwly}" varStatus="obj">
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="szcs" name="szcs" 
...
<!-- <div style="position:relative;"> 
        <span style="margin-left:100px;width:18px;overflow:hidden;"> 
            <select style="width:118px;margin-left:-100px" onchange="a(this.value)"> 
        ...
        <input id="cydd" name="cydd" style="width:100px;position:absolute;left:0px;"> 
    </div> -->
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
										        ...
										        <input class="form-control" id="cydd" name="cydd" 
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="cydw" name="cydw" maxlength="36"
                                                placeholder="最多输入36个字">
                                            </div>
                                            <label class="col-sm-2 col-sm-2 control-label">抽样人员：</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="cyry" name="cyry" maxlength="16" 
                                                placeholder="最多输入16个字">
                                            </div>
                                            <label class="col-sm-2 col-sm-2 control-label">抽样单编号：</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="cydbh" name="cydbh" maxlength="30" 
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                    	<div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="wtdwdz"
                                                               name="wtdwdz" maxlength="45" placeholder="最多输入45个字">
                                                    </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="sjdwdz"
                                                       name="sjdwdz" maxlength="45" placeholder="最多输入45个字">
                                            </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="scdwdz"
                                                       name="scdwdz" maxlength="45" placeholder="最多输入45个字">
                                            </div>
                                            <label class="col-sm-2 col-sm-2 control-label">标示产联系人：</label>

                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="scdwlxr"
                                                       name="scdwlxr" maxlength="8" placeholder="最多输入8个字">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="scdwgddh"
                                                       name="scdwgddh" maxlength="17" placeholder="最多输入17个字">
                                            </div>
                                        ...
                                        <div style="text-align: center;margin-top: 10px;">
                                    			...
                                    			<button type="button" class="btn btn-xs btn-success" style="width: 128px; height: 30px;" onClick="getSjdw();">被抽样单位同委托单位</button>
                                				<button type="button" class="btn btn-xs btn-success" style="width: 128px; height: 30px;" onClick="getScdw();">标示生产者同被抽样单位</button>		
                                        </div>
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                        ...
                                        width: 100%; margin-left: 0px; margin-right: 0px;">
                                            ...
                                            <div class="col-sm-10">
		            						<textarea class="form-control ckeditor textarea" rows="6" name="jyxm" maxlength="160"
                                        ...
                                        width: 100%; margin-left: 0px; margin-right: 0px;">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="jyhth" name="jyhth" maxlength="25" 
                                                placeholder="最多输入25个字">
                                            </div>
                                            <label class="col-sm-2 col-sm-2 control-label">检查封样人员：</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="jcfyry" name="jcfyry" maxlength="8" 
                                                placeholder="最多输入8个字">
                                            </div>
                                        </div>
                            ...
                            <input type="hidden" class="hidden" id="djlx" name="djlx" value="2">
