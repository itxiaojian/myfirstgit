...
<%-- 		var xMurl="<%=xMurl%>"; --%>
		...
		function save() {
			...
			msg="确定要领用？";
			if (confirm(msg)) {
				var url = "<%=path%>/ypgl/YYpYpxx/Tyang";
				$.ajax({
					cache : true,
					type : "POST",
					url : url,
			...
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
					...
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label">退样时间：</label>
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" id="tysj" name="tysj" 
							onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">退样数量：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="tysl" name="tysl">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">客方接收人：</label>
						<div class="col-sm-10">
					...
					<div class="form-group"
						...
						<label class="col-sm-2 col-sm-2 control-label">退样人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="tyr" name="tyr">
						</div>
					...
					<div class="form-group"
						...
						<div class="col-sm-13">
							...
							truetype="textarea" style="width: 1094px;"></textarea>
						</div>
					</div>
				</c:forEach>
				</form>
