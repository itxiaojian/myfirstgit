	...
	$(function(){
		...
		$("#myForm").validate({
			submitHandler: function() {
              ...
              msg = "确定要提交？";
              if (confirm(msg)) {
                  var saveurl = "<%=path%>/ypgl/YYpYpxx/ypfzSave";
		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
					...
					<input class="form-control" type="hidden" id="jyksbh" name="jyksbh" value="">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="ypbh" name="ypbh" value="" readonly="readonly">
                                                    </div>
                                                    <label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>报告编号：</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="bgbh" name="bgbh" value="" readonly="readonly">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="ypsl" name="ypsl" 
		                                                 placeholder="最多输入14个字" onKeyUp="checkLen(this,28)" value="${ypxx.ypsl }"/>
		                                            </div>
		                                        </div>
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                               <input class="form-control" type="text" id="gcdz" name="gcdz"required onKeyUp="checkLen(this,102)" 
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入25个字" value="${ypxx.jyhth}" >
		                                            </div>
