...
<%-- 		var xMurl="<%=xMurl%>"; --%>
		...
		//提交
		function save() {
			/* var ghsl = document.getElementById("ghsl").value;
			alert(ghsl);
			var lysl = ${lysl};
			alert(lysl);
			if (parseInt(ghsl) <= 0) {
		    ...
		    if (parseInt(ghsl) > parseInt(lysl)) {
				alert("归还数量大于领用数量，请重新输入");
				return false;
			}   */
			msg="确定要归还？";
			if (confirm(msg)) {
				var url = "<%=path%>/ypgl/YYpYpxx/Ghuan";
				$.ajax({
					cache : true,
					type : "POST",
					url : url,
			...
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
					...
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label">归还时间：</label>
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" id="ghsj" name="ghsj" 
							onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">客房接收人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="kfjsr" name="kfjsr">
						</div>
					...
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label">归还人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="ghr" name="ghr">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">办理人：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="blr" name="blr">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">归还数量：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="ghsl" name="ghsl">
						</div>
					</div>
