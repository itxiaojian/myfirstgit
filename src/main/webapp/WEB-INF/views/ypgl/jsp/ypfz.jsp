		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
					...
					<input class="form-control" type="hidden" id="jyksbh" name="jyksbh" >
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        minlength="1" data-msg-minlength="必填" type="text" onKeyUp="checkLen(this,72)"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入8个字" value="${ypxx.ypdj }" onKeyUp="checkLen(this,16)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        onKeyUp="checkLen(this,90)" placeholder="最多输入90个字">
                                                    </div>
                                                    <label class="col-sm-2 col-sm-2 control-label">生产日期批次：</label>

                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scrqpc" name="scrqpc" 
                                                        value="${ypxx.scrqpc }" placeholder="最多输入28个字" onKeyUp="checkLen(this,56)">
                                                    </div>
...
<!--                                                     <label class="col-sm-2 col-sm-2 control-label">待定</label>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
													...
													placeholder="最多输入120个字" onKeyUp="checkLen(this,240)" 
													data-msg-maxlength="最多输入120个字">${ypxx.bz}</textarea>
                                                    </div>
                                                </div>
