...
// 	                    oTest.insertBefore(newNode, befNode);
      ...
      //打开协议信息窗口
        ...
        function ypfz(id) {
        	...
        	var ypjyzt = document.getElementById("ypjyzt").value;
        	...
        	location.href="xgfzPageView?id="+id+"&oldId="+oldId+"&jyks="+jyksfz+"&ypbh="+ypbhfz
        			+"&zh="+zhfz+"&jyksbh="+jyksbhfz+"&djlx="+djlx+"&ypjyzt="+ypjyzt+"&djsj="+djsj;
       }
...
<div style="display:none;">
    <ul class="tab-menu tab" id="tabMenuID_">
        <li class="tab-selected" title="样品修改">
            <a href="<%=path%>/ypgl/YYpYpxx/YpdjPage" target="content" onfocus="this.blur()"><span>样品修改</span></a>
        </li>
    </ul>
</div>
<div class="wrapper">
		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
					...
					<input class="form-control" type="hidden" id="djry" name="djry" value="${djry }">
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
		                                                ...
		                                                placeholder="必填" id="ypmc" name="ypmc" onBlur="changeCpmccx();" value="${ypxx.ypmc }">
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        onKeyUp="checkLen(this,100)" placeholder="最多输入50个字">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scrqpc"
                                                               name="scrqpc" value="${ypxx.scrqpc }" onKeyUp="checkLen(this,56)" placeholder="最多输入28个字">
                                                    </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control Wdate" type="text" id="lyrq"  value="${ypxx.lyrq }"
		                                                       name="lyrq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		                                            </div> 
		                                            <label class="col-sm-2 col-sm-2 control-label">领样数量：</label>
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="lysl" name="lysl" value="${ypxx.lysl }" 
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="lyr" name="lyr"
		                                                 value="${ypxx.lyr }" onKeyUp="checkLen(this,16)" placeholder="最多输入8个字">
		                                            </div>
                                                </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="ypsl" name="ypsl" 
		                                                 placeholder="最多输入14个字"  value="${ypxx.ypsl }" onKeyUp="checkLen(this,28)"/>
		                                            </div>
		                                        </div>
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                               ...
		                                               placeholder="必填且最多输入36个字" value="${ypxx.gcmc }" >
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label"><span style="color:red">*</span>工程地址：</label>
		                                            <div class="col-sm-10">
		                                               <input class="form-control" type="text" id="gcdz" name="gcdz"required onKeyUp="checkLen(this,101)" 
		                                               placeholder="必填且最多输入51个字" value="${ypxx.gcdz }">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label">工程联系人：</label>
		                                            <div class="col-sm-10">
		                                               <input class="form-control" type="text" id="gclxr"
		                                                      value="${ypxx.gclxr }" name="gclxr" onKeyUp="checkLen(this,16)" placeholder="最多输入8个字">
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                data-rule-mobile="true" data-msg-mobile="请输入正确的手机号码格式" value="${ypxx.dh }">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label">施工单位：</label>
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="sgdw" name="sgdw" onKeyUp="checkLen(this,72)" 
		                                                placeholder="最多输入36个字" value="${ypxx.sgdw }">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label">设计单位：</label>
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="gcsjdw" name="gcsjdw" onKeyUp="checkLen(this,72)" 
		                                                placeholder="最多输入36个字" value="${ypxx.gcsjdw }">
		                                            </div>
		                                        </div>
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入36个字" value="${ypxx.wtdw }">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label">委托单位地址：</label>
		
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="wtdwdz"
		                                                       name="wtdwdz" onKeyUp="checkLen(this,90)" placeholder="最多输入45个字" value="${ypxx.wtdwdz }">
		                                            </div>
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="sjdwdz"
		                                                       name="sjdwdz" value="${ypxx.sjdwdz }" onKeyUp="checkLen(this,90)" placeholder="最多输入45个字">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label" style="width: 30%; margin-left: 2%; 
		                                            	   padding-top: 0px; margin-top: 3px;">
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="scdwdz"
		                                                 name="scdwdz" value="${ypxx.scdwdz }" onKeyUp="checkLen(this,90)" placeholder="最多输入45个字">
		                                            </div>
		                                            <label class="col-sm-2 col-sm-2 control-label" style="width: 30%; margin-left: 2%; 
		                                            	   padding-top: 0px; margin-top: 3px;">
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入36个字" value="${ypxx.jsdw }">
		                                            </div>
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入36个字" value="${ypxx.jldw }">
		                                            </div>
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入8个字" value="${ypxx.jlr }">
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入36个字" value="${ypxx.jzdw }">
		                                            </div>
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入8个字" value="${ypxx.jzr }">
		                                            </div>
		                                            ...
		                                            <div class="col-sm-10">
		                                                ...
		                                                placeholder="最多输入8个字" value="${ypxx.slr }">
		                                            </div>
		                                        </div>
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
										            ...
										            truetype="textarea" style="width: 409%;height: 35px;" onKeyUp="checkLen(this,320)" placeholder="最多输入160个字">${ypxx.jyxm }</textarea>
                                                    </div>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                  ...
                                                  placeholder="最多输入75个字">${ypxx.jyyj}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-sm-10">
													<select class="form-control input-lg m-bot15" name="jylx" required data-msg-required="必填" >
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="jyhth" name="jyhth"
                                                         onKeyUp="checkLen(this,50)" placeholder="最多输入25个字" value="${ypxx.jyhth}">
                                                    </div>
                                                    </c:if>
                                                    <c:if test="${sfzt == -1 }">
                                                    <label class="col-sm-2 col-sm-2 control-label" style="margin-top: -5px;
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
							                        ...
							                        <div class="box">
						                                <input type="text" name="copyFile"  class="textbox" value="${ypxx.fj}"/>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
													...
													placeholder="最多输入120个字">${ypxx.bz}</textarea>
                                                    </div>
                                                </div>
