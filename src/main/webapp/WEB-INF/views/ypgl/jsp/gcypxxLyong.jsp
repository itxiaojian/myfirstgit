...
<%-- 		var xMurl="<%=xMurl%>"; --%>
		...
		//提交
		function save() {
			/* var lysl = document.getElementById("lysl").value;
			//alert(parseInt(lysl));
			var ypsl = document.getElementById("ypsl").value;
			//alert(parseInt(ypsl));
			if (parseInt(lysl) <= 0) {
				alert("领用数量应大于0");
				return false;
			}
		    if (parseInt(lysl) > parseInt(ypsl)) {
		    	alert("领用数量大于样品数量，请重新输入");
		    	return false;
		    }	 */
			msg="确定要领用？";
			if (confirm(msg)) {
				var url = "<%=path%>/ypgl/YYpYpxx/Lyong";
				$.ajax({
					cache : true,
					type : "POST",
					url : url,
			...
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
	                   ...
	                   <div class="col-sm-10">
	                       <input class="form-control Wdate" type="text" value="${ypxx.lyrq }"
	                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" disabled="true">
	                   </div> 
	                   <label class="col-sm-2 col-sm-2 control-label">领样数量：</label>
	                   <div class="col-sm-10">
	                       <input class="form-control" type="text" value="${ypxx.lysl }" disabled="true"/> 
	                   </div>
	                   <label class="col-sm-2 col-sm-2 control-label">领样人：</label>
	                   <div class="col-sm-10">
	                       <input class="form-control" type="text" value="${ypxx.lyr }" disabled="true">
	                   </div>
                   </div>
                   ...
                   <div class="form-group"
                       ...
                       <div class="col-sm-10">
                           <input class="form-control" type="text" id="cydw" name="cydw" value="${ypxx.cydw }" readonly="readonly">
                       </div>
                   </div>					
					
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
                        <label class="col-sm-2 col-sm-2 control-label">工程名称：</label>
                        <div class="col-sm-10">
                           <input class="form-control" type="text" id="gcmc" name="gcmc" value="${ypxx.gcmc }" readonly="readonly">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">工程地址：</label>
                        <div class="col-sm-10">
                           <input class="form-control" type="text" id="gcdz" name="gcdz" value="${ypxx.gcdz }" readonly="readonly">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">工程联系人：</label>
                        <div class="col-sm-10">
                           <input class="form-control" type="text" id="gclxr" name="gclxr" value="${ypxx.gclxr }" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="dh" name="dh" value="${ypxx.dh }" readonly="readonly">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">施工单位：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sgdw" name="sgdw" value="${ypxx.sgdw }" readonly="readonly">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">设计单位：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="gcsjdw" name="gcsjdw" value="${ypxx.gcsjdw }" readonly="readonly">
                        </div>
                    </div>
					<div class="form-group"
                        style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" id="wtdw" name="wtdw" value="${ypxx.wtdw }" readonly="readonly">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">委托单位地址：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="wtdwdz" name="wtdwdz" value="${ypxx.wtdwdz }" readonly="readonly">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">受检单位：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sjdw" name="sjdw" value="${ypxx.sjdw }" readonly="readonly">
                        </div>
					</div>
					...
					<div class="form-group"
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sjdwdz" value="${ypxx.sjdwdz }" readonly="readonly">
                        </div>
						<label class="col-sm-2 col-sm-2 control-label">生产单位：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="scdw" name="scdw" value="${ypxx.scdw }" readonly="readonly">
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">生产单位地址：</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="scdwdz" value="${ypxx.scdwdz }" readonly="readonly">
                        </div>
					</div>
					...
					<div class="form-group"
						...
						<div class="col-sm-13">
							...
							truetype="textarea" style="width: 1091px;" disabled="true">${ypxx.jyxm }</textarea>
						</div>
					</div>
					...
					<div class="form-group"
						...
						<div class="col-sm-13">
							...
							truetype="textarea" style="width: 1091px;" disabled="true">${ypxx.jyyj }</textarea>
						</div>
					</div>
					...
					<div class="form-group"
						...
						<div class="col-sm-10">
						  <select class="form-control input-lg m-bot15" name="jylx" style="font-size:14px; height:40px;" disabled="true">
						...
						<div class="col-sm-10">
							<select class="form-control input-lg m-bot15" name="yhxtk" style="font-size:14px; height:40px;" disabled="true">
					...
					<%-- <div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label" >样品备注：</label>
						<div class="col-sm-13">
							<textarea class="form-control ckeditor textarea" rows="2" name="bz" 
							truetype="textarea" style="width: 1091px;" disabled="true">${ypxx.bz }</textarea>
						</div>
					</div> --%>
					
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label">领用时间：</label>
						<div class="col-sm-10">
							<input class="form-control Wdate" type="text" id="lysj" name="lysj" 
							onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">领用数量：</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" id="lysl" name="lysl" value="${ypxx.ypsl }">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">领用人：</label>
						<div class="col-sm-10">
					...
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label" >领用用途：</label>
						<div class="col-sm-13">
							<textarea class="form-control ckeditor textarea" rows="2" name="lyyt" 
							truetype="textarea" style="width: 1091px;" ></textarea>
						</div>
					</div>
					
					<div class="form-group"
                         style="padding-bottom: 2px;padding-top: 0px; margin-bottom: 0px; width: 101%;">
						<label class="col-sm-2 col-sm-2 control-label" >领用备注：</label>
						<div class="col-sm-13">
							<textarea class="form-control ckeditor textarea" rows="2" name="bz" 
							truetype="textarea" style="width: 1091px;" ></textarea>
						</div>
