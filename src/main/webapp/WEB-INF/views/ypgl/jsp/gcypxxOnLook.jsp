			...
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
                   ...
                   <div class="form-group"
	                   ...
	                   <div class="col-sm-10">
	                       <input class="form-control Wdate" type="text" id="lyrq"  value="${ypxx.lyrq }"
	                              name="lyrq" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly">
	                   </div> 
	                   <label class="col-sm-2 col-sm-2 control-label">领样数量：</label>
	                   <div class="col-sm-10">
	                       <input class="form-control" type="text" id="lysl" name="lysl" value="${ypxx.lysl }" readonly="readonly"/> 
	                   </div>
	                   <label class="col-sm-2 col-sm-2 control-label">领样人：</label>
	                   <div class="col-sm-10">
	                       <input class="form-control" type="text" id="lyr" name="lyr" value="${ypxx.lyr }" readonly="readonly">
	                   </div>
                   </div>
                   ...
                   <div class="form-group"
					...
					height: 40px; margin-bottom: 0px;"></div>
					...
					<div class="form-group"
						...
						<div class="col-sm-13">
							...
							truetype="textarea" style="width: 1094px;" disabled="true">${ypxx.bz }</textarea>
						</div>
					</div>
				</c:forEach>
				</form>
