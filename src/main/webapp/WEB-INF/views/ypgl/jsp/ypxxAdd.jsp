	                ...
	                success: function (data) {
	                    ...
	                    for (var i = 0; i < data.length; i++) {
	                        str = str + "<tr id='" + data[i].ID + "' name='" + data[i].ID + "'><td style='width:90px'>" + data[i].CPMC + "</td><td style='width:100px;display:none'>" + data[i].XMBH + "</td>"+"</td><td style='width:100px'>" + data[i].XMMC + "</td>"
	                                + "<td style='width:50px'>" + data[i].DJ + "</td><td style='width:50px'>"; 
	                                if(data[i].JLDW != null){
	                                	str = str + data[i].JLDW
	                                }else{
	                        			str = str + " " 
...
// 	                    oTest.insertBefore(newNode, befNode);
       ...
       <%--  //样品保存时保存检验项目信息
        ...
        function getScdw() {
           	...
           	$("#scdwlxr").val(lxr);
           	var dh1 = document.getElementById("dh").value;
           	$("#scdwdh").val(dh1);
    ...
    <script type="text/javascript">
     ...
     // 验证登录名是否重复
        function checkhth() {
        	var jyhth =$('#jyhth').val();
        	var url = '<%=path%>/ypgl/YYpYpxx/checkhth';
        	if(jyhth != null && jyhth !=""){
        	$.ajax({
        		cache: true,
                type: "POST",
        		...
        		success: function(data){
        			if(data =='0'){
        				alert('不存在该技术协议或该技术协议剩余金额不够此样品检验费用，请核对后重新输入！');
        				$("#jyhth").val("");
        			}
        		},
        	    error: function (request) {
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10" style="margin-top: 21px;">
                                                        <select class="form-control input-lg m-bot15"
                                                                id="zh" name="zh" required onclick="getBh();">
                                                            <option selected="selected" value="" onclick="" >请选择...
                                                            </option>
                                                            <option id="yzh" value="院字号" >院字号</option>
                                                            <option id="gpzxzh" value="国排中心字号" >
                                                                	国排中心字号
                                                            </option>
                                                            <option id="gjzxzh" value="国建中心字号" >
                                                               	 	国建中心字号
                                                            </option>
                                                            <option id="gazxzh" value="国安中心字号" >
                                                                	国安中心字号
                                                            </option>
                                                        </select>
                                                    </div> -->
                                                    ...
                                                    <!-- <label class="col-sm-2 col-sm-2 control-label" style="margin-bottom: 0px; 
                                                           border-bottom-width: 0px; padding-bottom: 0px; position: fixed; left: 0px; 
                                                           top: 138px; right: 0px; padding-left: 11px; width: 12.7%;">样品编号：</label>
                                                    <div class="col-sm-10"  style="position: fixed;">
                                                        <input class="form-control" type="text" id="ypbh" name="ypbh"
                                                               value="2015DQ00001" readonly="readonly">
                                                        <input id="ypbh" class="form-control" type="text" readonly="readonly" 
                                                        name="ypbh" style="width: 99%; margin-top: 62px; margin-left: 70%;">       
                                                    </div>
                                                    <label class="col-sm-2 col-sm-2 control-label" style="position: fixed;">报告编号：</label> -->       
                                                </div>
...
<!--                                                         <input class="form-control" type="text" id="ypmc" name="ypmc"> -->
                                                        ...
                                                        minlength="1" data-msg-minlength="必填" onKeyUp="checkLen(this,72)" type="text"
                                                        id="ypmc" name="ypmc" onBlur="changeCpmccx();" >
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="ypdj" name="ypdj" 
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="ypzt" name="ypzt"  
                                                        placeholder="最多输入38个字" onKeyUp="checkLen(this,76)">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入50个字" onKeyUp="checkLen(this,100)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="cyry" name="cyry" onKeyUp="checkLen(this,32)" 
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="cydd" name="cydd" onKeyUp="checkLen(this,90)"
                                                        placeholder="最多输入45个字">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入15个字" onKeyUp="checkLen(this,30)"/> 
                                                    </div>	
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <%-- <div class="col-sm-10">
                                                        <select class="form-control input-lg m-bot15" name="cydw" id="cydw">
                                                        	<option selected="selected" value="">请选择...</option>
                                                            <c:forEach var="cydw" items="${cydw}" varStatus="obj">
                                                                <option value="${cydw.zdz }">${cydw.zdmc }</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div> --%>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入36个字" ><!-- style="background:#00F; color:#000;"> -->
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式" 
                                                        placeholder="请输入正确的格式" minlength="6" maxlength="6">
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scdwdz"
                                                               name="scdwdz" onKeyUp="checkLen(this,90)" placeholder="最多输入45个字">
                                                    </div>
                                                    <label class="col-sm-2 col-sm-2 control-label">生产单位联系人：</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scdwlxr"
                                                               name="scdwlxr" onKeyUp="checkLen(this,16)" placeholder="最多输入8个字">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="scdwgddh"
                                                               name="scdwgddh" onKeyUp="checkLen(this,34)" placeholder="最多输入17个字">
                                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <label class="col-sm-2 col-sm-2 control-label">
                                                            <a href="#myModal" data-toggle="modal" class="btn btn-xs btn-sucess">选择检验项目</a>
                                                    </label>
                                                    </div>
                                                    <!-- <div class="col-sm-13">
                                                    </div> -->
										...
										<textarea class="form-control ckeditor textarea" rows="6" name="jyyj" id="jyyj"
                                                  ...
                                                  placeholder="最多输入75个字" onKeyUp="checkLen(this,150)"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="input-group m-bot15 col-sm-10" style="width: 19%;">
                                                        ...
                                                        data-msg-number="请输入正确的数字" data-gt="0"  maxlength="10" placeholder="最多输入10位数字" value="0"/>
                                                        <span class="input-group-addon">元</span>
<!--                                                     <label class="col-sm-2 col-sm-2 control-label">待定</label>
                                                    <div class="input-group m-bot15 col-sm-10">
                                                 		<input type="checkbox" name="jyfydd" value="0" checked="checked">
                                                 	</div> -->
                                                    </div>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="jyhth" name="jyhth" onBlur="checkhth()" 
                                                         onKeyUp="checkLen(this,50)" placeholder="最多输入25个字">
                                                    </div>
                                                    <label class="col-sm-2 col-sm-2 control-label">检查封样人员：</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="jcfyry" name="jcfyry" 
                                                        placeholder="最多输入8个字" onKeyUp="checkLen(this,16)">
                                                    </div>
                                                </div>
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-sm-13">
							<textarea class="form-control ckeditor textarea" rows="6" name="bz" placeholder="最多输入120个字"
							truetype="textarea" style="width: 99.5%;height: 35px;" onKeyUp="checkLen(this,240)" ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <input type="hidden" class="hidden" id="djlx" name="djlx" value="0">
                        ...
                        <div class="tab-pane" id="comments">
                             ...
                             <iframe id="test1" src="<%=path%>/ypgl/YYpYpxx/gcypxxAddView"  style="width:100%;height:550px;" frameborder="0" scrolling="no"></iframe>
                        </div>
                        
                        <div class="tab-pane" id="comments2">
                             <!-- <p><i class="icon-time"></i> 1 hours ago</p> -->
                             <iframe id="test1" src="<%=path%>/ypgl/YYpYpxx/syypxxAddView"  style="width:100%;height:550px;" frameborder="0" scrolling="no"></iframe>
                        </div> 
