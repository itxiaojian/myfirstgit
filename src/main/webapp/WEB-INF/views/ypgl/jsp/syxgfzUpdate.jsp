        	...
        	$.ajax({
        		...
        		success : function(data) {
                	...
                	var str="<table><thead><tr><th>样品编号</th><th>样品名称</th><th>样品类型</th><th>生产单位</th>"
        				   +"<th>操作</th></tr></thead><tbody>";
                	for(var i=0;i<data.length;i++){
                		str=str+"<tr id='"+isNull(data[i].ID)+"'><td>"+isNull(data[i].YPBH)+"</td><td>"+isNull(data[i].YPMC)+"</td><td>"+isNull(data[i].YPLX)
                                ...
                                <div class="panel-group m-bot20" id="accordion">
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10" style="margin-top: 21px;">
                                                        <!-- <select class="form-control input-lg m-bot15"
                                                                id="zh" name="zh" readonly="true">
                                                            <option selected="selected" value="" onclick="">请选择...
                                                            </option>
                                                            <option id="yzh" value="院字号" onclick="getBh()">院字号</option>
                                                            <option id="gpzxzh" value="国排中心字号" onclick="getBh()">
                                                                	国排中心字号
                                                            </option>
                                                            <option id="gjzxzh" value="国建中心字号" onclick="getBh()">
                                                               	 	国建中心字号
                                                            </option>
                                                            <option id="gazxzh" value="国安中心字号" onclick="getBh()">
                                                                	国安中心字号
                                                            </option>
                                                        </select> -->
                                                ...
                                                <div class="form-group"
													...
													<c:forEach items="${rwly}" var="rwly">
                                     				<c:choose>
                                         			<c:when test="${rwly.zdz == ypxx.rwly}">
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
												        ...
												        <input class="form-control" id="cydd" name="cydd" value="${ypxx.cydd }"
                                                ...
                                                <div class="form-group"
		                                            ...
		                                            <div class="col-sm-10">
		                                                <input class="form-control" type="text" id="cydbh" name="cydbh" value="${ypxx.cydbh }" 
                                    ...
                                    <div class="panel panel-default">
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="wtdwdz" name="wtdwdz" maxlength="45"
                                                         placeholder="最多输入45个字" value="${ypxx.wtdwdz }">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入8个字" value="${ypxx.wtlxr }">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        data-msg-mobile="请输入正确的格式" value="${ypxx.sjhm }">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        placeholder="最多输入17个字" value="${ypxx.wtdwgddh }">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        minlength="6" maxlength="6" placeholder="请输入正确的格式" value="${ypxx.wtyb }">
                                                    </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <label class="col-sm-2 col-sm-2 control-label">手机号码：</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="sjdwgddh" name="sjdwgddh" 
                                                placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                                                data-msg-mobile="请输入正确的格式" value="${ypxx.sjdwgddh }">
                                            </div>
                                            <label class="col-sm-2 col-sm-2 control-label">电话：</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="dh" name="dh" maxlength="17" 
                                                placeholder="最多输入17个字" value="${ypxx.dh }">
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                data-msg-number="请输入正确的格式" data-msg-minlength="请输入正确的格式" 
                                                minlength="6" maxlength="6" placeholder="请输入正确的格式" value="${ypxx.yb }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                placeholder="最多输入45个字" value="${ypxx.scdwdz }">
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                placeholder="最多输入8个字" value="${ypxx.scdwlxr }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                placeholder="请输入正确的手机号码格式" data-rule-mobile="true" 
                                                data-msg-mobile="请输入正确的格式" value="${ypxx.scdwdh }">
                                            </div>
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="jyhth" name="jyhth"
                                                         maxlength="25" placeholder="最多输入25个字" value="${ypxx.jyhth}">
                                                    </div>
                                                    </c:if>
                                                    <c:if test="${sfzt == -1 }">
                                                    <label class="col-sm-2 col-sm-2 control-label" style="margin-top: -5px;
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
													...
													placeholder="最多输入120个字" maxlength="120" >${ypxx.bz}</textarea>
                                                    </div>
                                                </div>
