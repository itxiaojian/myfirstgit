...
<div style="display:none;">
    <ul class="tab-menu tab" id="tabMenuID_">
        <li class="tab-selected" title="抽样登记">
            <a href="<%=path%>/ypgl/YYpYpxx/CydjPage" target="content" onfocus="this.blur()"><span>抽样登记</span></a>
        </li>
    </ul>
</div>
<div class="wrapper">
    <div class="panel">
        ...
        <div class="col-lg-12">
            <section class="panel" style="margin-bottom: 0px;">
                      ...
                      <div class="col-sm-10" style="margin-top: 21px;">
	                  <select class="form-control input-lg m-bot15" id="zh" name="zh" required onclick="getBh();">
                  ...
                  <div class="form-group"
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="sb" name="sb" maxlength="8" 
                          placeholder="最多输入8个字">
                      </div>
                  ...
                  <div class="form-group"
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="cydwyzbm" name="cydwyzbm" maxlength="8" placeholder="最多输入8个字" /> 
                      </div>	
                  </div>
                  ...
                  <div class="form-group"
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="czemail" name="czemail" maxlength="15" placeholder="最多输入15个字" /> 
                      </div>
                  ...
                  <div class="form-group"
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="yyzz" name="yyzz" maxlength="35" placeholder="最多输入35个字">
                      </div>
                      <label class="col-sm-2 col-sm-2 control-label">机构代码：</label>
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="jgdm" name="jgdm" maxlength="35" placeholder="最多输入35个字">
                      </div>
                      <label class="col-sm-2 col-sm-2 control-label">经济类型：</label>
                      <div class="col-sm-10">
                          <select class="form-control input-lg m-bot15" name="jjlx" id="jjlx" >
                          	<option selected="selected" value="">请选择...</option>
                  ...
                  <div class="form-group"
                      ...
                      <div class="col-sm-10">
                          <select class="form-control input-lg m-bot15" name="zslx" id="zslx" >
                          	<option selected="selected" value="">请选择...</option>
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="zsbh" name="zsbh" maxlength="35" placeholder="最多输入35个字">
                      </div>
...
<!--                                                     <label class="col-sm-2 col-sm-2 control-label">待定</label>
                                    ...
                                    <%-- <div class="form-group"
                                     ...
                                     <!-- <div class="form-group"
                    					 ...
                    					 <div class="box"><input type="text" name="copyFile"  class="textbox" />
                                     ...
                                     <div class="form-group"
                                         ...
                                         <div class="col-sm-13">
							                 <textarea class="form-control ckeditor textarea" rows="6" name="bz" placeholder="最多输入120个字"
												truetype="textarea" style="width: 99.5%;height: 35px;" maxlength="120" ></textarea>
                                          </div>
                                     </div>
