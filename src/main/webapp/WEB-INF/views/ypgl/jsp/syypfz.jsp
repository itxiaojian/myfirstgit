...
// 	                    oTest.insertBefore(newNode, befNode);
      ...
      //打开协议信息窗口
        ...
        //跳转到样品复制页面
        function ypfz(id) {
        	location.href="syypfzPageView?id="+id;
       }
		...
		<div class="panel-body">
			<div style="text-align:center;margin-bottom:10px"></div>
                ...
                <c:forEach var="ypxx" items="${ypxx}" varStatus="obj">
					...
					<input class="form-control" type="hidden" id="lysl" name="lysl" value="0">
                                            ...
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-10" style="margin-top: 21px;">
                                                        <input id="jyks" name="jyks" class="easyui-combotree" value=""
                                                    ...
                                                    <div class="col-sm-10" style="margin-top: 21px;">
                                                    	<input class="form-control" type="text" id="zh" name="zh" value="院字号" readonly="readonly">
                                                    </div>
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body" style="overflow:scroll;overflow-x:hidden">
                                                ...
                                                width: 100%; margin-left: 0px; margin-right: 0px;">
										            ...
										            truetype="textarea" style="width: 409%;height: 35px;" maxlength="160" 
