...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypJyfa.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="预检方案">
	<a href="<%=path%>/ypgl/YYpJyfa/YjfaPage" target="content" onfocus="this.blur()"><span>预检方案</span></a>
	</li>
</ul>
</div>
