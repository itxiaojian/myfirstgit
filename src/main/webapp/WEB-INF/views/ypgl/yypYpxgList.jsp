...
<%--   	<script language="javascript" src="<%=path%>/resources/lodop/LodopFuncs.js"></script> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypYpxg.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/ypgl/YYpYpxx/YpxgPage" target="content" onfocus="this.blur()"><span>样品修改</span></a>
	</li>
</ul>
</div>
