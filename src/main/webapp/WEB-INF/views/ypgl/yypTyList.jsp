...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypTy.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品退样">
	<a href="<%=path%>/ypgl/YYpTy/yptyPage" target="content" onfocus="this.blur()"><span>样品退样</span></a>
	</li>
</ul>
</div>
