...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypGh.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品归还">
	<a href="<%=path%>/ypgl/YYpGh/ypghPage" target="content" onfocus="this.blur()"><span>样品归还</span></a>
	</li>
</ul>
</div>
