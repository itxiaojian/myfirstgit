...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypLy.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品领用">
	<a href="<%=path%>/ypgl/YYpLy/yplyPage" target="content" onfocus="this.blur()"><span>样品领用</span></a>
	</li>
</ul>
</div>
