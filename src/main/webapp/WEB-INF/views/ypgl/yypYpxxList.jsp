...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/index.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypYpxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品信息">
	<a href="<%=path%>/ypgl/YYpYpxx/YpxxPage" target="content" onfocus="this.blur()"><span>样品信息</span></a>
	</li>
</ul>
</div>
