...
<%--   	<script language="javascript" src="<%=path%>/resources/lodop/LodopFuncs.js"></script> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypWsdjfh.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品预登记信息">
	<a href="<%=path%>/ypgl/YypWsdjfh/openPage" target="content" onfocus="this.blur()"><span>样品预登记信息</span></a>
	</li>
</ul>
</div>
