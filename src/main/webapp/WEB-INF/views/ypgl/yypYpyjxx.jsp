...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/index.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypYpyjxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品移交">
	<a href="<%=path%>/ypgl/YYpYj/ypyjPage" target="content" onfocus="this.blur()"><span>样品移交</span></a>
	</li>
</ul>
</div>
