...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/index.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ypgl/ypYpcx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="样品查询">
	<a href="<%=path%>/ypgl/YYpYpxx/YpcxPage" target="content" onfocus="this.blur()"><span>样品查询</span></a>
	</li>
</ul>
</div>
