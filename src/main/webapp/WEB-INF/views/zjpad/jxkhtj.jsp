...
<div class="ipad">
    ...
    <div class="ZJ_mian">
        ...
        <div class="ZJ_mian_right" id="main_R">
              <div class="row" style="height: 82%; width: 100%; margin-right: 0px; margin-left: 0px;">
                  <div class="col-lg-19" style="margin-left: 10%; width: 89%;">
                      <!--work progress start-->
                          ...
                          <div class="form-group" style="height: 35px; margin-bottom: 0px;">
                              ...
                              <label class="col-sm-2 control-label" style="width: 5%;">
                                 <a class="btn btn-xs btn-success" style="margin-top: 2px;" onclick="getExcelValue();" type="button" data-toggle="modal">返回</a>
                              </label>
						  </div>
						  </div>
						  <div id="Div3"></div>
						  ...
						  <br></br>
						  <table style="margin-left: 9%; width: 91%;"><thead><tr>
                  	      <td style="width: 126px;"><b>检验报告编号</b></td>
                  	      <td style="width: 142px;"><b>主检科室</b></td>
                  	      <td style="width: 200px;"><b>样品名称</b></td>
                  	      <td style="width: 48px;"><b>编制人</b></td>
                  	      <td style="width: 90px;"><b>样品登记日期</b></td>
						  ...
						  <div id="Div1" name="Div1" style="overflow: auto; height: 100%; width: 79%; margin-left: 9%;"></div>
						  </div>
</div>
</div>
