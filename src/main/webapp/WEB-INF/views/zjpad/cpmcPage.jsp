...
<%--                 <a href="<%=path%>/ypgl/YYpYj/ypyjPage;"><li><img src="<%=path%>/system/layout/img/L_09.png">&nbsp;&nbsp;样品移交</li></a> --%>
        ...
        <div class="ZJ_mian_right" id="main_R">
            <div class="panel-body" style="padding: 24px 0px 0px;">
            
	              <div class="form-group" style="height: 35px; margin-bottom: 0px;">
	                  <label class="col-sm-2 control-label" style="width:10%;top: 6px;">产品编号:</label>
					  <div class="col-sm-10" style="width:16%">
					  <input class="form-control" id="cpbh" name="cpbh" value="" style="height:28px;width: 100%;" value="${cpbh }"/>
					  </div>
	                  <label class="col-sm-2 control-label" style="width:10%;top: 6px;">产品名称:</label>
					  <div class="col-sm-10" style="width:16%">
					  <input class="form-control" id="cpmc" name="cpmc" value="" style="height:28px;width: 100%;" value="${cpmc }"/>
					  </div>
    ...
    <script type="text/javascript" src="<%=path%>/resources/js/jyzxxx/cpmcPage1.js"></script>
