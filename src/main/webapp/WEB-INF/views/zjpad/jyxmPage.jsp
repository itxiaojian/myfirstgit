...
<%--                 <a href="<%=path%>/ypgl/YYpYj/ypyjPage;"><li><img src="<%=path%>/system/layout/img/L_09.png">&nbsp;&nbsp;样品移交</li></a> --%>
        ...
        <div class="ZJ_mian_right" id="main_R">
            <div class="panel-body" style="padding-left: 0px; padding-right: 0px; padding-bottom: 0px;">
	              ...
	              <div class="form-group" style="height: 35px; margin-bottom: 0px;">
	                  <label class="col-sm-2 control-label" style="width:10%;top: 6px;">检验项目:</label>
					  <div class="col-sm-10" style="width:16%">
					  <input class="form-control" id="jyxm" name="jyxm" value="" style="height:28px;width: 100%;" value="${jyxm }"/>
					  </div>
					  <label class="col-sm-2 control-label" style="width: 7%;">
							<a class="btn btn-xs btn-success" data-toggle="modal" type="button" onclick="window.onload();" style="margin-top: 2px; padding-bottom: 3px; padding-top: 3px;">查询</a>
                      </label>
                      <label class="col-sm-2 control-label" style="width: 7%;">
                      ...
                      <label class="col-sm-2 control-label" style="width: 7%;">
                            <a class="btn btn-xs btn-success" data-toggle="modal" type="button" onclick="exit1();" style="margin-top: 2px; padding-bottom: 3px; padding-top: 3px;">返回</a>
                      </label>
               ...
               <div class="tab-content tasi-tab" style="padding-top: 31px;">
                   <div id="Div6" style="overflow: auto; height: 520px; padding-left: 0px; margin-left: 0px; margin-right: 0px; width: 100%;">
			...
			<input type="hidden" id="cpbh" name="cpbh" value="${cpbh}">
			<input type="hidden" id="jyyj" name="jyyj" value="${jyyj}">
		</div>
        </div>
    </div>
    </div></div>
    <div class="foot">安徽省产品质量监督检查研究院  皖ICP备08001861号-1  地址：合肥市包河工业园延安路13号  邮政编码：230051  电话：0551-63356268  63855622</div></div>
    ...
    <script type="text/javascript" src="<%=path%>/resources/js/jyzxxx/jyxmPage1.js"></script>
	...
	<script type="text/javascript"> 
		...
		function toView(cpbh,cplx,jyyj){
			location.href="jyxmView?cplx="+cplx+"&cpbh="+cpbh+"&jyyj="+jyyj;
		}
