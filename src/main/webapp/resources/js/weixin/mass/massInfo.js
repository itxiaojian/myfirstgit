...
var MPNEWS_GRID_STORE_URL = '/wxauth/mass/getMpnewsList';//图文消息
var PAGESIZE=20;
...
//		this.toObject.allowBlank = false;
        ...
        this.content = this.createTextArea('','content',100, '100%');
...
MpnewsSelectGrid = Ext.extend(UxGrid, {
    ...
    constructor: function(height, width){
        ...
        MpnewsSelectGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
                                          sm,
                {header:'图文消息名称',dataIndex:'scName',width:180,sortable: true},                           
                {header:'创建时间',dataIndex:'createTime',width:140,sortable: true}
            ]),
            ds: this.store
        });
