...
//		页面刚进来时执行的方法，动态分别加载表格
		...
		function creatTable(data){
		    ...
		    var str = "<table cellpadding='0' cellspacing='0' border='0' class='display table table-bordered'>" 
		                ...
		                +"<td class='hidden-phone'bgcolor='#63c3f5'><b>产品类型</B></td>"
		                +"<td class='hidden-phone'bgcolor='#3ab6f6'><b>操作</td></B>";
		   	...
		   	for(var i = 0; i < data.length; i++){
		   			str=str+"<td class='center hidden-phone' style='color:red;'>"+(i+1)+"</td>"
			   			   ...
			   			   +"<td class='center hidden-phone'><a href='javascript:;' onclick='toView(\""+data[i].ZDMC+"\")' class='paginate_disabled_previous'>查询产品</a></td>";;
			   		str=str+"</tr>";
			}
		   	str=str+"</tbody></table>";
