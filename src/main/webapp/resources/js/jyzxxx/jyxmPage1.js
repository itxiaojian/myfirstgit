...
//		}
		...
		function creatTable(data){
		    ...
		    var str = "<table cellpadding='0' cellspacing='0' border='0' class='display table table-bordered'>" 
		    	        ...
		    	        +"<td class='hidden-phone'bgcolor='#63c3f5'><b>检验依据</B></td>"
		                +"<td class='hidden-phone'bgcolor='#3ab6f6'><b>检验项目编号</B></td>"
		                +"<td class='hidden-phone'bgcolor='#119ee6'><b>检验项目</B></td>"
		                +"<td class='hidden-phone'bgcolor='#32a9eb'><b>对应标准条款号</B></td>"
		                +"<td class='hidden-phone'bgcolor='#63c3f5'><b>规格型号</B></td>"
		                +"<td class='hidden-phone'bgcolor='#3ab6f6'><b>样品数量</B></td>"
		                +"<td class='hidden-phone'bgcolor='#119ee6'><b>检测费用</B></td>"
		                +"<td class='hidden-phone'bgcolor='#32a9eb'><b>检验周期</B></td>"
		                +"<td class='hidden-phone'bgcolor='#63c3f5'><b>院资质认定</B></td>"
		                +"<td class='hidden-phone'bgcolor='#3ab6f6'><b>院CNAS</B></td>"
		                +"<td class='hidden-phone'bgcolor='#119ee6'><b>国排中心CMA/CAL</B></td>"
		                +"<td class='hidden-phone'bgcolor='#32a9eb'><b>国建中心CMA/CAL</B></td>"
		                +"<td class='hidden-phone'bgcolor='#63c3f5'><b>院食品资质认定</B></td>"
		                +"<td class='hidden-phone'bgcolor='#3ab6f6'><b>环境要求</B></td>"
		                +"<td class='hidden-phone'bgcolor='#119ee6'><b>设备编号</B></td>"
		                +"<td class='hidden-phone'bgcolor='#32a9eb'><b>设备名称</B></td>"
		                +"<td class='hidden-phone'bgcolor='#63c3f5'><b>人员</B></td>";
