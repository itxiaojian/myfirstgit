...
//			    }
		...
		function showTj(value){
			...
			if(xztj!=null&&xztj!=''){
				if(xztj=='between'){
					var str="";
					if(value=='FFRQ'||value=='TJRQ'||value=='BGBZRQ'||value=='BGDYSJ'||value=='JYJSRQ'||value=='CYRQ'||value=='DJSJ'||value=='DYRQ'||value=='LYRQ'||value=='WCQX'||value=='DJRQ'||value=='XGSJ'){
						str="<label>起始：</label><input name='qjq' id='qjq' type='text' style='width:34%;margin-left: 5px;' class='form-control1 Wdate textinput' onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" truetype='textinput' readonly='readonly'/>"
							+ "<label style='margin-left: 4%;'>截止：</label><input name='qjz' id='qjz' type='text' style='width:34%;margin-left: 5px;' class='form-control1 Wdate textinput' onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" truetype='textinput' readonly='readonly'/>";
						var oTest = document.getElementById("Div2");
						var newNode = document.createElement("div");
		...
		function addTj(){
			...
			if(xztj=='between'){
				...
				if(qjq==null||qjq==''||qjz==null||qjz==''){
					...
					if(xzlb=='or'){
						if(xzzd=='CYRQ'||xzzd=='DJSJ'||xzzd=='DYRQ'||xzzd=='LYRQ'||xzzd=='WCQX'||xzzd=='DJRQ'||xzzd=='XGSJ'){
							cxtj=cxtj+" "+xzlb+" (to_char(a."+xzzd+",'yyyy-mm-dd') "+xztj+" '"+qjq+"'and '"+qjz+"')";
						}else if(xzzd=='FFRQ'||xzzd=='TJRQ'||xzzd=='BGBZRQ'||xzzd=='BGDYSJ'||xzzd=='JYJSRQ'){
				...
				if(gjz==null||gjz==''){
					...
					if(xzzd=='JYJSRQ'||xzzd=='FFRQ'||xzzd=='TJRQ'||xzzd=='BGBZRQ'||xzzd=='BGDYSJ'||xzzd=='CYRQ'||xzzd=='DJSJ'||xzzd=='DYRQ'||xzzd=='LYRQ'||xzzd=='WCQX'||xzzd=='DJRQ'||xzzd=='XGSJ'||xzzd=='FPSJ'||xzzd=='BSSJ'||xzzd=='BPSJ'||xzzd=='PZSJ'||xzzd=='JSSJ'||xzzd=='GDSJ'){
						if(xzlb=='or'){
							if(xztj=='like'||xztj=='not like'){
								if(xzzd=='CYRQ'||xzzd=='DJSJ'||xzzd=='DYRQ'||xzzd=='LYRQ'||xzzd=='WCQX'||xzzd=='DJRQ'||xzzd=='XGSJ'){
									cxtj=" "+xzlb+" (to_char(a."+xzzd+",'yyyy-mm-dd') "+xztj+" '"+gjz+"')";
								}else if(xzzd=='FFRQ'||xzzd=='TJRQ'||xzzd=='BGBZRQ'||xzzd=='BGDYSJ'){
						...
						if(xzlb=='or'){
							if(xztj=='like'||xztj=='not like'){
								if(xzzd=='BGBH'||xzzd=='BGMC'||xzzd=='JSDW'||xzzd=='JSR'||xzzd=='FFZT'||xzzd=='TJYY'||xzzd=='TJR'||xzzd=='BZFS'||xzzd=='JYJL'||xzzd=='RZFS'||xzzd=='BSDX'||xzzd=='DYZT'||xzzd=='DYCS'||xzzd=='SFJS'||xzzd=='JYQKSM'){
									...
									if(xzzd=='SHR'){
										...
										cxtj=" "+xzlb+" (q.YSFJE "+xztj+" '%"+gjz+"%')";
											...
											cxtj=" "+xzlb+" to_char(a."+xzzd+") "+xztj+" '"+gjz+"'";
									}else{
...
//			$('#cxtj').val(cxtj);
		...
		function creatTable(strs,data,values){
		    ...
		    var str = "<table cellpadding='0' cellspacing='0' border='0' class='display table table-bordered'><thead><tr> " +
		    		"<th class='hidden-phone'style='width: 53px;'>报告状态</th>";
...
//	              alert(workDayVal - weekendDay);	
		   		...
		   		}else if(data[i].YPZT1 > 3 && data[i] != 8){
				   		//起始日期，<span style="background-color: rgb(204, 204, 204);"><span style="color:#FF0000;"><strong>/pattern/是正则表达式的界定符，pattern是要匹配的内容，只用于第一个符号的匹配，g为全局匹配标志</strong></span></span>  
...
//		   			}
		   			...
		   			if(values[j]=='YPMC'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YPMC)+"</td>";
		   			}
		   			if(values[j]=='YPJYZT'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YPJYZT)+"</td>";
		   			}
		   			if(values[j]=='WCQX'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].WCQX)+"</td>";
		   			}
		   			if(values[j]=='QSR'){
		   			...
		   			if(values[j]=='BZR'){
		   				if(data[i].YPZT1 >= 0 && data[i].YPZT1 != 8){
		   					if(data[i].YPZT1 == 0 || data[i].YPZT1 == 1 && data[i].YPZT1 != 8){
		   						str=str+"<td class='center hidden-phone'>"+isNull(data[i].BZR)+"</td>";
		   					}else if(data[i].YPZT1 >= 2 && data[i].YPZT1 != 8){
		   						str=str+"<td class='center hidden-phone'>"+isNull(data[i].BZR)+"</td>";
		   					}
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   			...
		   			if(values[j]=='SHR'){
		   				if(data[i].YPZT1 >= 2 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].SHR)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='PZR'){
		   				if(data[i].YPZT1 >= 3 && data[i].YPZT1 != 8){
		   					if(data[i].YPZT1 == 3 && data[i].YPZT1 != 8){
		   						str=str+"<td class='center hidden-phone'>"+isNull(data[i].PZR)+"</td>";
		   					}else if(data[i].YPZT1 >= 4 && data[i].YPZT1 != 8){
		   						str=str+"<td class='center hidden-phone'>"+isNull(data[i].PZR1)+"</td>";
		   					}
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			...
		   			if(values[j]=='JYLX'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYLX)+"</td>";
		   			}
		   			if(values[j]=='FPSJ'){
		   				if(data[i].YPZT1 >0 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].FPSJ)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='BSSJ'){
		   				if(data[i].YPZT1 > 1 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].BSSJ)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='BPSJ'){
		   				if(data[i].YPZT1 >= 3 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].BPSJ)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='PZSJ'){
		   				if(data[i].YPZT1 >= 4 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].PZSJ)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='JSSJ'){
		   				if(data[i].YPZT1 > 4 && data[i].YPZT1 != 8){
		   					str=str+"<td class='center hidden-phone'>"+isNull(data[i].JSSJ)+"</td>";
		   				}else{
		   					str=str+"<td class='center hidden-phone'></td>";
		   				}
		   			}
		   			if(values[j]=='GDSJ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].GDSJ)+"</td>";
		   			}
		   			if(values[j]=='GGXH'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].GGXH)+"</td>";
		   			}
		   			if(values[j]=='SCRQPC'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SCRQPC)+"</td>";
		   			}
		   			if(values[j]=='JYJL'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYJL)+"</td>";
		   			}
		   			if(values[j]=='YPZT'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YPZT)+"</td>";
		   			}
		   			if(values[j]=='YPSL'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YPSL)+"</td>";
		   			}
		   			if(values[j]=='WTDW'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].WTDW)+"</td>";
		   			}
		   			if(values[j]=='WTDWDZ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].WTDWDZ)+"</td>";
		   			}
		   			if(values[j]=='SJDW'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SJDW)+"</td>";
		   			}
		   			if(values[j]=='SJDWDZ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SJDWDZ)+"</td>";
		   			}
		   			if(values[j]=='LXR'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].LXR)+"</td>";
		   			}
		   			if(values[j]=='DH'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].DH)+"</td>";
		   			}
		   			if(values[j]=='YB'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YB)+"</td>";
		   			}
		   			if(values[j]=='SCDW'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SCDW)+"</td>";
		   			}
		   			if(values[j]=='SCDWDZ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SCDWDZ)+"</td>";
		   			}
		   			if(values[j]=='SCDWLXR'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SCDWLXR)+"</td>";
		   			}
		   			if(values[j]=='SCDWDH'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SCDWDH)+"</td>";
		   			}
		   			if(values[j]=='WTLXR'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].WTLXR)+"</td>";
		   			}
		   			if(values[j]=='SJHM'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SJHM)+"</td>";
		   			}
		   			if(values[j]=='JYYJ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYYJ)+"</td>";
		   			}
		   			if(values[j]=='JYXM'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYXM)+"</td>";
		   			}
		   			if(values[j]=='JYFY'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYFY)+"</td>";
		   			}
		   			if(values[j]=='YSFJE'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YSFJE)+"</td>";
		   			}
		   			if(values[j]=='JYJSRQ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYJSRQ)+"</td>";
		   			}
		   			if(values[j]=='DYRQ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].DYRQ)+"</td>";
		   			}
		   			if(values[j]=='JYKS'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYKS)+"</td>";
		   			}
		   			if(values[j]=='YWKS'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].YWKS)+"</td>";
		   			}
		   			if(values[j]=='DJRY'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].DJRY)+"</td>";
		   			}
		   			if(values[j]=='DJSJ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].DJSJ)+"</td>";
		   			}
		   			if(values[j]=='DJLX'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].DJLX)+"</td>";
		   			}
		   			if(values[j]=='CYDW'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].CYDW)+"</td>";
		   			}
		   			if(values[j]=='CYJS'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].CYJS)+"</td>";
		   			}
		   			if(values[j]=='CYRQ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].CYRQ)+"</td>";
		   			}
		   			if(values[j]=='CYRY'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].CYRY)+"</td>";
		   			}
		   			if(values[j]=='BZ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].BZ)+"</td>";
		   			}
		   			if(values[j]=='SB'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SB)+"</td>";
		   			}
		   			if(values[j]=='JYRQ'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].JYRQ)+"</td>";
		   			}
		   			if(values[j]=='SJDWGDDH'){
			   			str=str+"<td class='center hidden-phone'>"+isNull(data[i].SJDWGDDH)+"</td>";
		   			}
		   		}
		   		str=str+"</tr>";
		   	}
