var USER_GRID_STORE_URL = 'getXyysfList';
var PAGESIZE=20;
...
//                '-',{text:'修改',iconCls: 'edit',handler:this.onModifyClick,scope:this},
        ...
        ConstructionGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
							...
							if(record.get("SFR") == -1){
	                  		   return"<a href='javascript:;' onclick='constructionGrid.onLook()' style='text-decoration:none;'>" +
							   		 ...
							   		 "<a href='javascript:;' onclick='constructionGrid.onTfei()' style='text-decoration:none;'>" +
							   		  "<span style='width: 26px;cursor: pointer;'>&nbsp&nbsp&nbsp&nbsp退费&nbsp&nbsp&nbsp&nbsp</span></a>"+
							   		  "&nbsp&nbsp&nbsp"+
               		            ...
               		            }else if(record.get("SFR") == 2){
     	                  		   return"<a href='javascript:;' onclick='constructionGrid.onLook()' style='text-decoration:none;'>" +
							   		  "<span style='width: 26px;cursor: pointer;'>查看</span></a>"+
							   		  "&nbsp&nbsp&nbsp"+
							   		  "<a href='javascript:;' onclick='' style='text-decoration:none;'>" + 
		                              "<span style='width: 25px;color:gray;'>退费记录</span></a>"+
							   		  "&nbsp&nbsp&nbsp"+
							   		  "<a href='javascript:;' onclick='constructionGrid.onUpdatejl()' style='text-decoration:none;'>" +
							   		  "<span style='width: 26px;cursor: pointer;'>修改</span></a>"+
							   		  "&nbsp;&nbsp;&nbsp"+
      	                  		   ...
      	                  		   return"<a href='javascript:;' onclick='constructionGrid.onLook()' style='text-decoration:none;'>" +
							   		  ...
							   		  "&nbsp&nbsp&nbsp"+
							   		  "<a href='javascript:;' onclick='' style='text-decoration:none;'>" + 
		                              "<span style='width: 25px;color:gray;'>&nbsp&nbsp已退费&nbsp&nbsp</span></a>"+
							   		  "&nbsp&nbsp&nbsp"+
							   		  "<a href='javascript:;' onclick='constructionGrid.onUpdatejl()' style='text-decoration:none;'>" +
							   		  "<span style='width: 26px;cursor: pointer;'>修改</span></a>"+
							   		  "&nbsp;&nbsp;&nbsp"+
                ...
                {header:'协议类型',dataIndex:'XYLX',width:100,sortable: true},
    	...
    	var records=this.getSelectionModel().getSelections();
   		if(records.length > 0) {
   			if(records.length == 1){
   				...
   				var id=records[0].get('ID');
   				var xybh=records[0].get('XYBH');
   				var url = "xysfonTfeiView?id="+id+"&xybh="+xybh;
				html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
				ACT_DEAL_WINDOW = new ActDealWindow();
        	...
        	var records=this.getSelectionModel().getSelections();
       		if(records.length > 0) {
       			if(records.length == 1){
       				...
       				var id=records[0].get('ID');
       				var xybh=records[0].get('XYBH');
       				var url = "onUpdatejl?id="+id+"&xybh="+xybh;
    				html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
    				ACT_DEAL_WINDOW = new ActDealWindow();
