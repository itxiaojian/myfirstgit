var USER_GRID_STORE_URL = 'getXzinfoKcList';
    ...
    constructor: function(height, width){
        ...
        ConstructionGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
                ...
                {header:'人员编号',dataIndex:'RYBH',width:120,sortable: true},
                {header:'月份',dataIndex:'YF',width:120,sortable: true},
            	{header:'缺勤扣除',dataIndex:'QQKC',width:120,sortable: true},
            	{header:'养老保险',dataIndex:'YLBX',width:80,sortable: true,},
                {header:'医保',dataIndex:'YB',width:120,sortable: true},
                {header:'失业保险',dataIndex:'SYBX',width:120,sortable: true},
            	{header:'社保小计',dataIndex:'SBXJ',width:120,sortable: true},
            	{header:'住房公积金',dataIndex:'ZFGJJ',width:120,sortable: true},
            	{header:'个税',dataIndex:'GS',width:120,sortable: true},
            	{header:'扣除小计',dataIndex:'KCXJ',width:120,sortable: true},
...
//    	win.constructionForm.getForm().reset();
    	var url = "xzkcAddView?id="+id;  	
		html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
		ACT_DEAL_WINDOW = new ActDealWindow();
		ACT_DEAL_WINDOW.setTitle("增加薪资扣除信息");
    ...
    onModifyClick: function() {
		...
		var url = "xzkcXgView?id="+id;  	
		html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
		ACT_DEAL_WINDOW = new ActDealWindow();
		ACT_DEAL_WINDOW.setTitle("修改薪资扣除信息");
		ACT_DEAL_WINDOW.html = html;
		ACT_DEAL_WINDOW.show();
    },
