var USER_GRID_STORE_URL = 'getHyxxList';
var PAGESIZE=20;
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
                            ...
                            {name:'ID'},{name:'HYBH'},{name:'HYMC'},{name:'BZ'},{name:'SSFL'},
                            {name:'JB'}
...
//                {header:'行业编号',dataIndex:'HYBH',width:150,sortable: true},
                {header:'行业名称',dataIndex:'HYMC',width:150,sortable: true},
                {header:'所属分类',dataIndex:'SSFL',width:150,sortable: true,
                ...
                {header:'分类级别',dataIndex:'JB',width:80,sortable: true},
            	...
            	{header : '操作',width : 100,dataIndex : 'sbbh',align : "center",sortable : true,hidden : false,renderer : function(value,cellmeta,record)
				{
					return "<a href='javascript:;' style='text-decoration:none;'>"
								+"<span style='width: 25px;cursor: pointer;'></span></a>&nbsp;&nbsp;&nbsp"+
    ...
    onAddClick: function() {
    	...
    	var url = "hyAddView?id="+id;  	
		html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
		ACT_DEAL_WINDOW = new ActDealWindow();
		ACT_DEAL_WINDOW.setTitle("登记客户分类");
	 ...
	 onModifyClick: function() {
			...
			var url = "hyxxXgView?id="+id;  	
			html = '<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="' + url + '"></iframe>';    		
			ACT_DEAL_WINDOW = new ActDealWindow();
			ACT_DEAL_WINDOW.setTitle("编辑客户分类");
			ACT_DEAL_WINDOW.html = html;
			ACT_DEAL_WINDOW.show();
	    },
