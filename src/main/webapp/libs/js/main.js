...
//var ifrWidth = document.getElementById("content").width;
//var ifrHeight = document.getElementById("content").height;
$(function() {
...
jQuery.fn.extend({
	fullSrceenRender: function() {
		...
		b.toggle(function() {
			...
			$(this).removeClass(a);
			$(this).addClass(c);
			document.getElementById("content").height=window.screen.availHeight-180;
			document.getElementById("content").width=window.screen.availWidth-10;
			document.getElementById("tabContent").style.height=document.getElementById("content").height+'px';
		}, function() {
			...
			$(this).removeClass(c);
			$(this).addClass(a);
			document.getElementById("content").height=window.screen.availHeight-300;
			document.getElementById("content").width=window.screen.availWidth-200;
			document.getElementById("tabContent").style.height=document.getElementById("content").height+'px';
		})
	},
