...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wfw/zsPjxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/wfw/ZsPjxx/pjxxPage" target="content" onfocus="this.blur()"><span>评教信息</span></a>
	</li>
</ul>
</div>
