    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {     
           var view="week";          
            ...
            var DATA_FEED_URL = "<%=path%>/wfw/ZsKb/getBjkb";
            var op = {
                view: view,
                theme:3,
                showday: new Date(),
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="班级课表">
	<a href="#" target="content" onfocus="this.blur()"><span>班级课表</span></a>
	</li>
</ul>
</div>
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle">班级课表</div>
