	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<form name="submitForm" id="optionForm" method="post"
				...
				<input type="hidden" name="lcnr" id="lcnr"/>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 流程名称</span>
				...
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 流程种类</span>
					<select class="form-control input-sm" name="lczl" value="" >
					    <c:forEach items="${list}" var="list">
						    <option value="${list.zdz}" selected="selected">${list.zdmc}</option>
							</c:forEach>
					</select>
				</div>
				<br>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/wzy/ZyLcxx/saveLCXX',   //默认是form的action， 如果申明，则会覆盖  
	...
	function agree() {
		...
		document.getElementById("lcnr").value=UM.getEditor('myEditor').getContent();
		if(returnFlag) {
