...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyXyxgxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="学院相关信息">
	<a href="<%=path%>/wzy/ZyXyxgxx/xyxgxxPage" target="content" onfocus="this.blur()"><span>学院相关信息</span></a>
	</li>
</ul>
</div>
