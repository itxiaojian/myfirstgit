...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyDhhl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="电话黄历">
	<a href="<%=path%>/wzy/ZyDhhl/dhhlPage" target="content" onfocus="this.blur()"><span>一电话黄历</span></a>
	</li>
</ul>
</div>
