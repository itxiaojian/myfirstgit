...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyYjjy.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="一键救援">
	<a href="<%=path%>/wzy/ZyYjjy/yjjyPage" target="content" onfocus="this.blur()"><span>一键救援</span></a>
	</li>
</ul>
</div>
