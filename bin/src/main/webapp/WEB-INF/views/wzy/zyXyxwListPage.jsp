...
<body>
	...
	<div class="panel panel-success">
		<div id="opinionDiv" class="panel-heading"><font color="red">*</font> 新闻发布:</div>
		<div class="panel-body">
			<form name="submitForm" id="optionForm" method="post"
				...
				<input type="hidden" name="xwnr" id="xwnr"/>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 新闻标题</span>
					<input type="text" class="form-control" placeholder="请输入新闻标题"
						value="" name="xwbt"
						id="xwbt" />
				</div>
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 新闻注释</span>
					<input type="text" class="form-control" placeholder="请输入新闻注释"
						value="" name="xwzs"
						id="xwzs" />
				</div>
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 新闻类型</span>
					<select class="form-control input-sm" name="xwlx" value="" >
						    <option value="1" selected="selected">院部新闻</option>
							<option value="2" >校内新闻</option>
					</select>
				</div>
				<br>
				...
				<br>
				<div align="center">
 					<input type="submit" class="btn btn-primary" onclick="agree();" value="发布" />
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/wzy/ZyXyxw/saveXYXW',   //默认是form的action， 如果申明，则会覆盖  
	...
	function agree() {
		...
		document.getElementById("xwnr").value=UM.getEditor('myEditor').getContent();
		if(returnFlag) {
