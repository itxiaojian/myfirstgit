...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyLcxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="流程信息">
	<a href="<%=path%>/wzy/ZyLcxx/lcxxPage" target="content" onfocus="this.blur()"><span>流程信息</span></a>
	</li>
</ul>
</div>
