...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyXyxw.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="校院新闻">
	<a href="<%=path%>/wzy/ZyXyxw/xyxwPage" target="content" onfocus="this.blur()"><span>校院新闻</span></a>
	</li>
</ul>
</div>
