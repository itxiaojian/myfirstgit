...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/zs/TxTxxxlsjl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="提醒管理配置">
	<a href="<%=path%>/wtx/TxTxxxlsjl/index" target="content" onfocus="this.blur()"><span>提醒管理配置</span></a>
	</li>
</ul>
</div>
</body>
