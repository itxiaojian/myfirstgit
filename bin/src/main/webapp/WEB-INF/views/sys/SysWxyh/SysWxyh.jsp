...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sys/SysWxyh.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="微信用户">
	<a href="<%=path%>/sys/SysWxyh/wxyhPage" target="content" onfocus="this.blur()"><span>微信用户</span></a>
	</li>
</ul>
</div>
</body>
