...
// 					document.getElementById('lidw1').scrollIntoView(true);
					...
					if(parseInt(size/10)==1){
						document.getElementById('lidw10').scrollIntoView(true);
					}else{
						var num=(parseInt(size/10)-1)*10-1;
// 						alert(num);
// 						alert(parseInt(size/10));
						var id='lidw'+num;
...
<div class="bg1" >
	...
	<div class="s-app__hd action-bar ng-scope" ng-hide="actionBar.hide" ng-controller="ActionBarCtrl as actionBar" style="margin-top: 57px;background-color: white;">


		<h1 class="action-bar__tie" ng-switch="actionBar.viewList.length">
			<c:if test="${lx=='2'}">
				<span class="action-bar__tie__norm ng-binding ng-scope" ng-switch-when="1" ng-bind="actionBar.viewList[0].name">我捡到的</span>
			</c:if>	
			<c:if test="${lx=='1'}">
				<span class="action-bar__tie__norm ng-binding ng-scope" ng-switch-when="1" ng-bind="actionBar.viewList[0].name">我弄丢了</span>
			</c:if>
			<c:if test="${lx==''}">
	...
	<div class="-hd ng-scope" ng-switch-default="" style="margin-top: 57px;">

		<ul class="-list01">
			<li class="-list01-item" ng-class="{
			        &#39;active&#39;: helpList.isFound
			    }">
				<a href="<%=path%>/wsh/ShSwzl/toSwzlList">
...
<!-- 						<i class="-list01-item__icon fa fa-smile-o"></i> -->
			...
			<li class="-list01-item" ng-class="{
				...
				<a href="<%=path%>/wsh/ShSwzl/toSwzlList?lx=2">
...
<!-- 						<i class="-list01-item__icon fa fa-heart"></i> -->
			...
			<li class="-list01-item">
				<a href="<%=path%>/wsh/ShSwzl/toSwzlList?lx=1">
