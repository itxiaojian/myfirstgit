...
<!DOCTYPE html>
<!-- saved from url=(0051)http://weixiao.qq.com/home/14284/activity/add_apply -->
<html>
	<head>
...
<div id="add_apply_modal">
	<div class="modal-header">
		<h3 id="modal_label">问卷查看</h3>
	</div>
	 <p class="help-block"></p>
  <form name="fm" class="form-horizontal" method="post" action="" novalidate="novalidate">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="title" placeholder="" class="input-xlarge" value="${map.title }" disabled="disabled">
            <p class="help-block"></p>
          </div>
     </div>
      ...
      <div class="control-group">
          ...
          <div class="controls">
            <div class="textarea">
                  <textarea type="" class="" name="discribe" cols="10" rows="4" style="width: 280px" disabled="disabled">${map.discribe }</textarea>
            </div>
          </div>
      </div>
      ...
      <div class="control-group">
          ...
          <div class="controls" style="position: relative;">
            	       是<input name="anonymousFlag" type="radio" value="1" <c:if test="${map.anonymousFlag=='1' }">checked="checked"</c:if> disabled="disabled"/>&nbsp;&nbsp;
                                                                否<input name="anonymousFlag" type="radio" value="0" <c:if test="${map.anonymousFlag=='0' }">checked="checked"</c:if> disabled="disabled"/>
            </p>
          </div>
     </div>
