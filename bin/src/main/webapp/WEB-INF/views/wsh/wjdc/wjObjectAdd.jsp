...
<div id="add_apply_modal">
	<div class="modal-header">
		<h3 id="modal_label">添加问卷</h3>
	</div>
	 <p class="help-block"></p>
  <form name="fm" class="form-horizontal" method="post" action="<%=path%>/wsh/WjObject/save" novalidate="novalidate">
    <fieldset>
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="title" placeholder="" class="input-xlarge" value="">
            <p class="help-block"></p>
          </div>
     </div>
      ...
      <div class="control-group">
          ...
          <div class="controls">
            <div class="textarea">
                  <textarea type="" class="" name="discribe" cols="10" rows="4" style="width: 280px"> </textarea>
            </div>
          </div>
      </div>
