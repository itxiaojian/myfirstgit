...
<FORM class="search-box" action="<%=path%>/wsh/ShEssc/toEsscSpList" method="post">
<DIV class="input-wr clearfix">
<DIV class="search-input"><IMG class="search-icon" src="<%=path%>/resources/js/wsh/essc/search-icon.png"> 
                <INPUT name="keyword" id="keyword" type="text" placeholder="搜索你想要的商品" value=""> 
                <INPUT name="openId" id="openId" type="hidden" value="${openId}"> 
            </DIV><INPUT class="search-btn" type="submit" value="搜索">         
...
<DIV class="wrap-btn" style="width:100%;"><A class="btn btn-publish" style="width:100%;" href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx872c32778ea444c4&redirect_uri=http%3A%2F%2Fwx.zs-si.com%3A8080%2Fwxpt%2Fwsh%2FShEssc%2FtoEsscAdd&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect"><IMG 
