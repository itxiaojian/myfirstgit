...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/shxcsk/shXcsk.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="校车时刻查询">
	<a href="<%=path%>/wsh/ShXcsk/xcskPage" target="content" onfocus="this.blur()"><span>一校车信息</span></a>
	</li>
</ul>
</div>
