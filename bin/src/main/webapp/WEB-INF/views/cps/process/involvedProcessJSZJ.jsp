...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="已审批技术总监">
	<a href="<%=path%>/cps/processXN/involvedProcessJSZJ" target="content" onfocus="this.blur()"><span>已审批技术总监</span></a>
	</li>
</ul>
</div>
