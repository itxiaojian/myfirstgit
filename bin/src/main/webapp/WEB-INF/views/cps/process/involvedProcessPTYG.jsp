...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="已审批普通员工">
	<a href="<%=path%>/cps/processXN/involvedProcessPTYG" target="content" onfocus="this.blur()"><span>已审批普通员工</span></a>
	</li>
</ul>
</div>
