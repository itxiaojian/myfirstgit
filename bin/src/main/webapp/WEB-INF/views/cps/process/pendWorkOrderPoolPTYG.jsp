...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="审批普通员工">
		<a href="<%=path%>/cps/process/taskXN/pendWorkPoolIndexPTYG" target="content" onfocus="this.blur()"><span>审批普通员工</span></a>
	</li>
</ul>
</div>
