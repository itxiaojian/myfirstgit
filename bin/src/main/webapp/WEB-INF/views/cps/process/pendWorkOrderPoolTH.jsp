...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/pendWorkOrderPoolUpdate.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="我的退回任务">
		<a href="<%=path%>/cps/process/taskXN/pendWorkPoolIndexTH" target="content" onfocus="this.blur()"><span>我的退回任务</span></a>
	</li>
</ul>
</div>
