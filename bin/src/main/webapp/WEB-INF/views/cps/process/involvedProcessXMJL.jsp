...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="已审批项目经理">
	<a href="<%=path%>/cps/processXN/involvedProcessXMJL" target="content" onfocus="this.blur()"><span>已审批项目经理</span></a>
	</li>
</ul>
</div>
