...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/cps/process/involvedProcess.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="已审批部门经理">
	<a href="<%=path%>/cps/processXN/involvedProcessBMJL" target="content" onfocus="this.blur()"><span>已审批技术部门经理</span></a>
	</li>
</ul>
</div>
