...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="已审批市场人员">
	<a href="<%=path%>/cps/processXN/involvedProcessSCRY" target="content" onfocus="this.blur()"><span>已审批市场人员</span></a>
	</li>
</ul>
</div>
