var USER_GRID_STORE_URL = 'getYjjyList';
var PAGESIZE=20;
...
ConstructionForm = Ext.extend(Ext.ux.Form, {
    ...
    constructor: function() {
        ...
        this.dhhm = this.createTextField('<font color="red">*</font>电话号码:' , 'dhhm', '85%','',null,12,'电话号码不能为空!' );
        this.bz = this.createTextField('<font color="red">*</font>备注:', 'bz', '85%','备注不能为空！');
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
                           {name:'id'},{name:'bmmc'},{name:'dhhm'},{name:'bz'}
            ])
        });
...
//            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true},
            	...
            	*/
            	...
            	{header:'电话号码',dataIndex:'dhhm',width:200,sortable: true},
            	{header:'备注',dataIndex:'bz',width:260,sortable: true, }
            ]),
            tbar: this.vtbar,
            bbar: this.vbbar,
            ds: this.store,
