var USER_GRID_STORE_URL = 'getWdtcList';
var PAGESIZE=20;
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
            		{name:'id'},{name:'tcbt'},{name:'tczs'},{name:'tcnr'},{name:'tcsj'},{name:'gqsj'},{name:'tcr'}
            		,{name:'tcrxm'},{name:'bmmc'},{name:'bmbh'},{name:'zt'},
            ])
        });
...
//        });    	
        ...
        ConstructionGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
                ...
                {header:'吐槽人编号',dataIndex:'tcr',width:80,sortable: true, hidden:true},
                {header:'发布部门',dataIndex:'bmbh',width:80,sortable: true, hidden:true},
//            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true},
            	{header:'吐槽内容',dataIndex:'tcnr',width:200,sortable: true, 
            	},
            	{header:'吐槽人',dataIndex:'tcrxm',width:200,sortable: true},
            	{header:'部门名称',dataIndex:'bmmc',width:200,sortable: true},
            	{header:'吐槽时间',dataIndex:'tcsj',width:200,sortable: true},
            ]),
            tbar: this.vtbar,
            bbar: this.vbbar,
            ds: this.store,
