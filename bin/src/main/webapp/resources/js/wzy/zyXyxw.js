var USER_GRID_STORE_URL = 'getXyxwList';
var PAGESIZE=20;
...
//            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true},
            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true, 
                    renderer:function(value, cellmeta, record){
                    	...
                    	return '<a target="_blank" href="zyXyxwDetail?id=' + id + '">' + value + '</a>';
                    }
            	},
            	...
            	{header:'新闻类型',dataIndex:'xwlx',width:260,sortable: true, 
            		renderer:function(value){
	                    if(value == '1') {
	                        return "<span style='color:blue;'>院部新闻</span>";
	                    }else if(value == '2') {
	                        return "<span style='color:red;'>校内新闻</span>";
	                    }else{
	                        return value;
	                    }
            		}
