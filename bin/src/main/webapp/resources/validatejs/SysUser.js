var saveSysUserConfig = {
	fullname:[{rule:notBlank,msg:"用户名 不能为空"},{rule:length,params:{min:0,max:255},msg:"用户名 长度不在0-255范围"}],
	...
	lastLoginTime:[{rule:date,msg:"最后登录时间 必须是日期"}],
...
var saveSysYhConfig = {
		...
		gwbh:[{rule:notBlank,msg:"岗位 不能为空"},{rule:length,params:{min:0,max:255},msg:"岗位 长度不在0-255范围"}],
